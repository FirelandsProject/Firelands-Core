...
#if 0 /* FIRELANDS exclude for disabled gui prompt */
#ifdef G3D_OSX
...
#endif
#endif /* FIRELANDS exclude for disabled gui prompt */
...
int prompt(
    ...
    int              numChoices,
    bool             useGui) {
#if 0 /* FIRELANDS: disable guid prompt at all platforms, MacOS case have build problems, other just useless */
    #ifdef G3D_WIN32
        if (useGui) {
