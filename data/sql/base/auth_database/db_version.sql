...
INSERT INTO `db_version` (`version`, `structure`, `content`, `description`, `comment`) VALUES
	(21, 2, 1, 'Add_field_comments', 'Base Database FDB_21_02_01'),
	(21, 3, 1, 'Update Row format and engine', 'Update to FDB_21_03_01'),
	(21, 4, 1, 'fix account table errors', 'Update to FDB_21_04_01'),
	(22, 1, 1, 'New DB Release 22', 'Update to FDB_22_01_01');
