...
CREATE TABLE IF NOT EXISTS `points_of_interest` (
  `entry` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'POI ID.',
  `x` float NOT NULL DEFAULT '0' COMMENT 'X coordinate.',
  `y` float NOT NULL DEFAULT '0' COMMENT 'Y coordinate.',
  `icon` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'POI icon.',
  `flags` mediumint unsigned NOT NULL DEFAULT '0',
  `data` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Custom data to be sent for a point of interest. ',
