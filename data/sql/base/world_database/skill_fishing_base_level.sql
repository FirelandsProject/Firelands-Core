...
CREATE TABLE IF NOT EXISTS `skill_fishing_base_level` (
  `entry` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Area ID (See AreaTable.dbc).',
  `skill` smallint NOT NULL DEFAULT '0' COMMENT 'Fishing skill value.',
  PRIMARY KEY (`entry`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Fishing system';
