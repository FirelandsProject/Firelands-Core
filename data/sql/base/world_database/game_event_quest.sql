...
CREATE TABLE IF NOT EXISTS `game_event_quest` (
  `quest` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Quest ID (See quest_template.entry).',
  `event` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Event ID (see game_event.entry).',
