...
CREATE TABLE IF NOT EXISTS `spell_chain` (
  `spell_id` mediumint NOT NULL DEFAULT '0' COMMENT 'Spell ID.',
  `prev_spell` mediumint NOT NULL DEFAULT '0' COMMENT 'Previous rank of the spell.',
  `first_spell` mediumint NOT NULL DEFAULT '0' COMMENT 'Lowest rank spell.',
  `rank` tinyint NOT NULL DEFAULT '0' COMMENT 'Rank.',
  `req_spell` mediumint NOT NULL DEFAULT '0' COMMENT 'Required spell ID.',
  PRIMARY KEY (`spell_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Spell Additinal Data';
