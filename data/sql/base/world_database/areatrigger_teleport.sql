...
CREATE TABLE IF NOT EXISTS `areatrigger_teleport` (
  `id` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'The ID of the trigger (See AreaTrigger.dbc).',
  `name` text COMMENT 'The name of the teleport areatrigger.',
  `required_level` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The player needs to be at least this level.',
  `required_item` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Requested an item (See item_template.entry).',
  `required_item2` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Requested an item (See item_template.entry).',
  `heroic_key` mediumint unsigned NOT NULL DEFAULT '0',
  `heroic_key2` mediumint unsigned NOT NULL DEFAULT '0',
  `required_quest_done` int unsigned NOT NULL DEFAULT '0' COMMENT 'Requires quest (See quest_template.entry).',
  `required_quest_done_heroic` int unsigned NOT NULL DEFAULT '0',
  `target_map` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'The destination map id. (See map.dbc)',
