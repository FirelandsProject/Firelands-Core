...
CREATE TABLE IF NOT EXISTS `command` (
  `id` mediumint unsigned NOT NULL AUTO_INCREMENT COMMENT 'The unique Command ID.',
  `command_text` varchar(50) NOT NULL DEFAULT '' COMMENT 'The Command Name.',
  `security` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The minimum security level to use the command (See account.gmlevel) in the realm',
  `help_text` longtext COMMENT 'The help text for the command which explains it''s use and parameters.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Chat System';
