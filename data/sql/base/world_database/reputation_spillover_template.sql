...
CREATE TABLE IF NOT EXISTS `reputation_spillover_template` (
  `faction` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Base faction (See Faction.dbc).',
  `faction1` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Dependent faction (See Faction.dbc).',
  `rate_1` float NOT NULL DEFAULT '0' COMMENT 'Rate for faction one.',
  `rank_1` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The topmost rank allowed.',
  `faction2` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Dependent faction (See Faction.dbc).',
  `rate_2` float NOT NULL DEFAULT '0' COMMENT 'Rate for faction two.',
  `rank_2` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The topmost rank allowed.',
  `faction3` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Dependent faction (See Faction.dbc).',
  `rate_3` float NOT NULL DEFAULT '0' COMMENT 'Rate for faction three.',
  `rank_3` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The topmost rank allowed.',
  `faction4` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'Dependent faction (See Faction.dbc).',
  `rate_4` float NOT NULL DEFAULT '0' COMMENT 'Rate for faction four.',
  `rank_4` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'The topmost rank allowed.',
  `faction5` smallint unsigned DEFAULT '0',
  `rate_5` float NOT NULL DEFAULT '0',
  `rank_5` tinyint unsigned DEFAULT '0',
  PRIMARY KEY (`faction`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Reputation spillover reputation gain';
