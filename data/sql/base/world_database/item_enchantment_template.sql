...
CREATE TABLE IF NOT EXISTS `item_enchantment_template` (
  `entry` mediumint NOT NULL DEFAULT '0' COMMENT 'Random property type (See item_template.RandomProperty).',
  `ench` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Enchantment type (See ItemRandomProperties.dbc).',
  `chance` float unsigned NOT NULL DEFAULT '0' COMMENT 'Chance to get the enchantment (%).',
  PRIMARY KEY (`entry`,`ench`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Item Random Enchantment System';
