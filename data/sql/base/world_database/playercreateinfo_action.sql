...
CREATE TABLE IF NOT EXISTS `playercreateinfo_action` (
  ...
  `button` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'The ID of the button on the action ba.',
  `action` int unsigned NOT NULL DEFAULT '0' COMMENT 'See description in the lower half of this page..',
  `type` smallint unsigned NOT NULL DEFAULT '0' COMMENT 'The following values are valid types:',
