...
CREATE TABLE IF NOT EXISTS `battlemaster_entry` (
  `entry` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'The ID of the creature (See creature_template.entry).',
  `bg_template` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'The battleground template ID (See Battleground_template).',
  PRIMARY KEY (`entry`)
