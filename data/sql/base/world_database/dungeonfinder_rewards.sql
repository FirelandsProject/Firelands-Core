...
CREATE TABLE IF NOT EXISTS `dungeonfinder_rewards` (
  ...
  `level` mediumint unsigned NOT NULL COMMENT 'uint32',
  `base_xp_reward` mediumint unsigned NOT NULL COMMENT 'uint32',
  `base_monetary_reward` int NOT NULL COMMENT 'int32',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;

DELETE FROM `dungeonfinder_rewards`;
