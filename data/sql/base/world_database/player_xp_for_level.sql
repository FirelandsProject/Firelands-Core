...
CREATE TABLE IF NOT EXISTS `player_xp_for_level` (
  `lvl` int unsigned NOT NULL COMMENT 'The player''s level.',
  `xp_for_next_level` int unsigned NOT NULL COMMENT 'The experience needed to upgrade from the value in lvl field to lvl +1.',
  PRIMARY KEY (`lvl`)
