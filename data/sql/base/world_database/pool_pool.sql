...
CREATE TABLE IF NOT EXISTS `pool_pool` (
  `pool_id` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Pool ID (See pool_template.entry).',
  `mother_pool` mediumint unsigned NOT NULL DEFAULT '0' COMMENT 'Mother pool ID.',
