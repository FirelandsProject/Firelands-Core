...
CREATE TABLE IF NOT EXISTS `player_levelstats` (
  `race` tinyint unsigned NOT NULL COMMENT 'A bit-mask corresponding to races that should get the spell. ',
  `class` tinyint unsigned NOT NULL COMMENT 'A bit-mask corresponding to class that should get the spell',
  `level` tinyint unsigned NOT NULL COMMENT 'The level at which the stats should be applied.',
  `str` tinyint unsigned NOT NULL COMMENT 'The base strength of the character.',
  `agi` tinyint unsigned NOT NULL COMMENT 'The base agility of the character.',
  `sta` tinyint unsigned NOT NULL COMMENT 'The base stamina of the character.',
  `inte` tinyint unsigned NOT NULL COMMENT 'The base intellect of the character.',
  `spi` tinyint unsigned NOT NULL COMMENT 'The base spirit of the character.',
