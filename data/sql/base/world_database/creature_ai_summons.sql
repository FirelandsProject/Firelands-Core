...
CREATE TABLE IF NOT EXISTS `creature_ai_summons` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'This references the third action parameter in the Creature_ai_scripts.',
  ...
  `spawntimesecs` int unsigned NOT NULL DEFAULT '120' COMMENT 'The despawn timer for the summoned creature.',
  `comment` varchar(255) NOT NULL DEFAULT '' COMMENT 'Documents what kind of creature will be summoned.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='EventAI Summoning Locations';
