...
CREATE TABLE IF NOT EXISTS `spell_template` (
  ...
  `attr` int unsigned NOT NULL DEFAULT '0',
  `attr_ex` int unsigned NOT NULL DEFAULT '0',
  `attr_ex2` int unsigned NOT NULL DEFAULT '0',
  `attr_ex3` int unsigned NOT NULL DEFAULT '0',
  ...
  `effect0_implicit_target_b` int unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='MaNGOS server side spells';
