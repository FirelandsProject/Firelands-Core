...
CREATE TABLE IF NOT EXISTS `exploration_basexp` (
  `level` tinyint NOT NULL DEFAULT '0' COMMENT 'Area level (See AreaTable.dbc).',
  `basexp` mediumint NOT NULL DEFAULT '0' COMMENT 'Base XP reward.',
  PRIMARY KEY (`level`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='Exploration System';
