...
MACRO(FC_ADD_SCRIPT path)
    CU_ADD_GLOBAL("FC_SCRIPTS_SOURCES" "${path}")
ENDMACRO()
...
MACRO(FC_ADD_SCRIPT_LOADER script_dec include)
    ...
    if (${num_lower_prio_scripts} GREATER 0)
        CU_GET_GLOBAL("FC_ADD_SCRIPTS_LIST")
        ...
        endforeach()
        CU_ADD_GLOBAL("FC_ADD_SCRIPTS_LIST" "Add${script_dec}Scripts()\;")
        foreach(lower_prio_script ${removed_lower_prio_scripts})
            CU_ADD_GLOBAL("FC_ADD_SCRIPTS_LIST" "Add${lower_prio_script}Scripts()\;")
        endforeach()
    else()
        CU_ADD_GLOBAL("FC_ADD_SCRIPTS_LIST" "Add${script_dec}Scripts()\;")
    endif()
    ...
    if (NOT ${include} STREQUAL "")
        CU_GET_GLOBAL("FC_ADD_SCRIPTS_INCLUDE")
        if (NOT ";${FC_ADD_SCRIPTS_INCLUDE};" MATCHES ";${include};")
            CU_ADD_GLOBAL("FC_ADD_SCRIPTS_INCLUDE" "${include}\;")
        endif()
    endif()
ENDMACRO()
