...
calculating maps positions using the *firelands* map tools built during the build
process.
...
Also, you will have to run a full build of *firelands* to create all map tools.
