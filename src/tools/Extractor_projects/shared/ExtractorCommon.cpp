...
/**
*  This function displays the standard firelands banner to the console
*
*  @PARAM sTitle is the Title text (directly under the Firelands logo)
...
void showBanner(const std::string& sTitle, int iCoreNumber)
{
    ...
    case CLIENT_WOTLK:
        ...
        break;
    case CLIENT_CATA:
        printf("FirelandsThree\n");
        break;
    case CLIENT_MOP:
        printf("FirelandsFour\n");
        break;
    case CLIENT_WOD:
        printf("FirelandsFive\n");
        break;
    case CLIENT_LEGION:
        printf("FirelandsSix\n");
        break;
...
/**
*  This function displays the standard firelands help banner to the console
*/
void showWebsiteBanner()
{
    printf(
        ...
        "    Website / Forum / Wiki: http://github.com/FirelandsProject  \n"
        "  ________________________________________________\n"
        );
}
