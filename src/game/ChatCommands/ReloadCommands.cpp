...
bool ChatHandler::HandleReloadAllCommand(char* /*args*/)
{
    ...
    HandleReloadFirelandsStringCommand((char*)"");
...
bool ChatHandler::HandleReloadFirelandsStringCommand(char* /*args*/)
{
    sLog.outString("Re-Loading firelands_string Table!");
    sObjectMgr.LoadFirelandsStrings();
    SendGlobalSysMessage("DB table `firelands_string` reloaded.", SEC_MODERATOR);
    return true;
}
