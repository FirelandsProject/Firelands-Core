...
bool ChatHandler::HandleMmapTestArea(char* args)
{
    ...
    Firelands::AnyUnitInObjectRangeCheck go_check(m_session->GetPlayer(), radius);
    Firelands::CreatureListSearcher<Firelands::AnyUnitInObjectRangeCheck> go_search(creatureList, go_check);
    // Get Creatures
