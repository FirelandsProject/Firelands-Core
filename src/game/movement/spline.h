...
#ifndef _FIRELANDS_SPLINE_H
#define _FIRELANDS_SPLINE_H
...
namespace Movement
{
    ...
    class SplineBase
    {
        ...
        protected:
             ...
             *
             */
            void UninitializedSpline() const { FIRELANDS_ASSERT(false);}
        ...
        public:
            ...
            template<class T> inline void initLengths(T& cacher)
            {
                ...
                while (i < index_hi)
                {
                    ...
                    FIRELANDS_ASSERT(prev_length <= new_length);
