...
#ifndef FIRELANDS_H_FIRELANDS_LANGUAGE
#define FIRELANDS_H_FIRELANDS_LANGUAGE
...
enum FirelandsStrings
{
    ...
    LANG_WAYPOINT_NOTFOUNDDBPROBLEM                           = 223,    /* Creature (GUID: %u) No waypoints found - This is a Firelands db problem (single float). */
...
Faction Template: %u. */
    ...
    LANG_SCRIPTS_OUTDATED                                     = 1169,    /* Scripting library build for different worldserver revision. */
