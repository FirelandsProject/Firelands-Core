 ...
 * The mailing system in Firelands consists of mostly 4 files:
 * - Mail.h
 * - Mail.cpp
 * - MassMailMgr.h
 * - MassMailMgr.cpp
 ...
 *
 * @file MassMailMgr.h
 * This file contains the the headers needed for Firelands to handle mass mails send in safe and perfomence not affecting way.
 *
 */

#ifndef FIRELANDS_MASS_MAIL_MGR_H
#define FIRELANDS_MASS_MAIL_MGR_H
...
#define sMassMailMgr Firelands::Singleton<MassMailMgr>::Instance()
