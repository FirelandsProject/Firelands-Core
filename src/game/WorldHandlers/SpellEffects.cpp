        ...
        case SPELLFAMILY_GENERIC:
        {
            switch (m_spellInfo->Id)
            {
                ...
                case 45583:                                 // Throw Gnomish Grenade
                {
                    ...
                    Firelands::NearestGameObjectEntryInPosRangeCheck go_check_big(*unitTarget, 187675, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Firelands::GameObjectSearcher<Firelands::NearestGameObjectEntryInPosRangeCheck> checker1(pGo, go_check_big);
                    ...
                    Firelands::GameObjectEntryInPosRangeCheck go_check_small(*unitTarget, 187676, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Firelands::GameObjectListSearcher<Firelands::GameObjectEntryInPosRangeCheck> checker2(lList, go_check_small);
                ...
                case 46171:                                 // Scuttle Wrecked Flying Machine
                {
                    ...
                    Firelands::NearestGameObjectEntryInPosRangeCheck go_check(*unitTarget, 187675, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Firelands::GameObjectSearcher<Firelands::NearestGameObjectEntryInPosRangeCheck> checker(pGo, go_check);
                ...
                case 49634:                                 // Sergeant's Flare
                {
                    ...
                    // TODO: Firelands::DynamicObjectUpdater::VisitHelper prevent aura to be applied to dummy creature (see HandleAuraDummy for effect of aura)
                ...
                case 51866:                                 // Kick Nass
                {
                    ...
                    Firelands::NearestCreatureEntryWithLiveStateInObjectRangeCheck u_check(*m_caster, 28523, true, false, fRange * 2);
                    Firelands::CreatureLastSearcher<Firelands::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(pTargetDummy, u_check);
                ...
                case 52371:                                 // Detonate Explosives
                {
                    ...
                    Firelands::GameObjectEntryInPosRangeCheck go_check(*unitTarget, 182071, unitTarget->GetPositionX(), unitTarget->GetPositionY(), unitTarget->GetPositionZ(), fMaxDist);
                    Firelands::GameObjectListSearcher<Firelands::GameObjectEntryInPosRangeCheck> checker(lList, go_check);
...
void Spell::EffectSummonType(SpellEffectEntry const* effect)
{
    ...
    {
        FIRELANDS_ASSERT(itr->creature || itr != summonPositions.begin());
        if (!itr->creature)
        {
...
{
    FIRELANDS_ASSERT(!list.empty() && prop);
        ...
        case SPELLFAMILY_GENERIC:
        {
            switch (m_spellInfo->Id)
            {
                ...
                case 44462:                                 // Cast Quest Complete on Master
                {
                    ...
                    Firelands::NearestCreatureEntryWithLiveStateInObjectRangeCheck u_check(*m_caster, 24797, true, false, range);
                    Firelands::CreatureLastSearcher<Firelands::NearestCreatureEntryWithLiveStateInObjectRangeCheck> searcher(pQuestCow, u_check);
