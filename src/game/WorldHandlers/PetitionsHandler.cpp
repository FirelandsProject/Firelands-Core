...
void WorldSession::HandlePetitionShowSignOpcode(WorldPacket& recv_data)
{
    ...
    data << uint32(petitionguid_low);                       // guild guid (in firelands always same as GUID_LOPART(petitionguid)
...
void WorldSession::HandlePetitionQueryOpcode(WorldPacket& recv_data)
{
    ...
    uint32 guildguid;
    ObjectGuid petitionguid;
    recv_data >> guildguid;                                 // in firelands always same as GUID_LOPART(petitionguid)
    recv_data >> petitionguid;                              // petition guid
...
void WorldSession::SendPetitionQueryOpcode(ObjectGuid petitionguid)
{
    ...
    data << uint32(petitionLowGuid);                        // guild/team guid (in firelands always same as GUID_LOPART(petition guid)
...
void WorldSession::HandleOfferPetitionOpcode(WorldPacket& recv_data)
{
    ...
    data << petitionGuid;                                   // petition guid
    data << _player->GetObjectGuid();                       // owner guid
    data << uint32(petitionGuid.GetCounter());              // guild guid (in firelands always same as low part of petition guid)
    data << uint8(signs);                                   // sign's count
