 ...
 * The Transport System in Firelands consists of these files:
 ...
 * This file contains the headers for base clases needed for Firelands to handle passengers on transports
 *
 */
