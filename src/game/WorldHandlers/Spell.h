...
#ifndef FIRELANDS_H_SPELL
#define FIRELANDS_H_SPELL
...
class Spell
{
        friend struct Firelands::SpellNotifierPlayer;
        friend struct Firelands::SpellNotifierCreatureAndPlayer;
