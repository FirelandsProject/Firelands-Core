...
void Firelands::RespawnDo::operator()(Creature* u) const
{
...
void Firelands::RespawnDo::operator()(GameObject* u) const
{
...
void Firelands::CallOfHelpCreatureInRangeDo::operator()(Creature* u)
{
    if (u == i_funit)
    {
        return;
...
bool Firelands::AnyAssistCreatureInRangeCheck::operator()(Creature* u)
{
    if (u == i_funit)
    {
        return false;
