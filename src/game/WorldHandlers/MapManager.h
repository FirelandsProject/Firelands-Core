...
class MapManager : public Firelands::Singleton<MapManager, Firelands::ClassLevelLockable<MapManager, ACE_Recursive_Thread_Mutex> >
{
        friend class Firelands::OperatorNew<MapManager>;

        typedef ACE_Recursive_Thread_Mutex LOCK_TYPE;
        typedef ACE_Guard<LOCK_TYPE> LOCK_TYPE_GUARD;
        typedef Firelands::ClassLevelLockable<MapManager, ACE_Recursive_Thread_Mutex>::Lock Guard;
    ...
    public:
        ...
        {
            return IsValidMAP(mapid) && Firelands::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
            return IsValidMAP(mapid) && Firelands::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
            return IsValidMAP(mapid) && Firelands::IsValidMapCoord(x, y, z, o);
        }
