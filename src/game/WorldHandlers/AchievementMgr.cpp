...
void AchievementMgr::SendAchievementEarned(AchievementEntry const* achievement)
{
    ...
    {
        Firelands::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        Firelands::LocalizedPacketDo<Firelands::AchievementChatBuilder> say_do(say_builder);
    ...
    {
        Firelands::AchievementChatBuilder say_builder(*GetPlayer(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        Firelands::LocalizedPacketDo<Firelands::AchievementChatBuilder> say_do(say_builder);
        Firelands::CameraDistWorker<Firelands::LocalizedPacketDo<Firelands::AchievementChatBuilder> > say_worker(GetPlayer(), sWorld.getConfig(CONFIG_FLOAT_LISTEN_RANGE_SAY), say_do);
...
void AchievementMgr::DoFailedTimedAchievementCriterias()
{
    ...
    for (AchievementCriteriaFailTimeMap::iterator iter = m_criteriaFailTimes.begin(); iter != m_criteriaFailTimes.end();)
    {
        ...
        if (!IsCompletedCriteria(criteria, achievement))
        {
            ...
            FIRELANDS_ASSERT(pro_iter != m_criteriaProgress.end());
...
void AchievementGlobalMgr::LoadAchievementCriteriaList()
{
    ...
    for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows(); ++entryId)
    {
        ...
        FIRELANDS_ASSERT(criteria->requiredType < ACHIEVEMENT_CRITERIA_TYPE_TOTAL && "Not updated ACHIEVEMENT_CRITERIA_TYPE_TOTAL?");
