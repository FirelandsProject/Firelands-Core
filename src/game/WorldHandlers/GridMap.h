...
#ifndef FIRELANDS_GRIDMAP_H
#define FIRELANDS_GRIDMAP_H
...
class TerrainManager : public Firelands::Singleton<TerrainManager, Firelands::ClassLevelLockable<TerrainManager, ACE_Thread_Mutex> >
{
        typedef UNORDERED_MAP<uint32,  TerrainInfo*> TerrainDataMap;
        friend class Firelands::OperatorNew<TerrainManager>;
    ...
    private:
        ...
        typedef Firelands::ClassLevelLockable<TerrainManager, ACE_Thread_Mutex>::Lock Guard;
