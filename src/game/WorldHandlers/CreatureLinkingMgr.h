 ...
 * This NPC-linking system in Firelands consists of 2 files:
 ...
 * This file contains the the headers needed for Firelands to link NPCs together
 *
 */
...
#define sCreatureLinkingMgr Firelands::Singleton<CreatureLinkingMgr>::Instance()
