...
class MapPersistentStateManager : public Firelands::Singleton<MapPersistentStateManager, Firelands::ClassLevelLockable<MapPersistentStateManager, ACE_Thread_Mutex> >
{
...
#define sMapPersistentStateMgr Firelands::Singleton<MapPersistentStateManager>::Instance()
#endif
