...
void WorldSession::HandleTextEmoteOpcode(WorldPacket& recv_data)
{
    ...
    Firelands::CameraDistWorker<Firelands::LocalizedPacketDo<Firelands::EmoteChatBuilder > > emote_worker(GetPlayer(), sWorld.getConfig(CONFIG_FLOAT_LISTEN_RANGE_TEXTEMOTE), emote_do);
