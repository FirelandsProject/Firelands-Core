...
class ChatHandler
{
    public:
        ...
        virtual const char* GetFirelandsString(int32 entry) const;
    ...
    protected:
        ...
        bool HandleReloadFirelandsStringCommand(char* args);
...
class CliHandler : public ChatHandler
{
    public:
        ...
        // overwrite functions
        const char* GetFirelandsString(int32 entry) const override;
