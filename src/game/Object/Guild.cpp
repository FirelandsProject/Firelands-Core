...
void Guild::CreateDefaultGuildRanks(int locale_idx)
{
    ...
    CreateRank(sObjectMgr.GetFirelandsString(LANG_GUILD_MASTER, locale_idx),   GR_RIGHT_ALL);
    CreateRank(sObjectMgr.GetFirelandsString(LANG_GUILD_OFFICER, locale_idx),  GR_RIGHT_ALL);
    CreateRank(sObjectMgr.GetFirelandsString(LANG_GUILD_VETERAN, locale_idx),  GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(sObjectMgr.GetFirelandsString(LANG_GUILD_MEMBER, locale_idx),   GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
    CreateRank(sObjectMgr.GetFirelandsString(LANG_GUILD_INITIATE, locale_idx), GR_RIGHT_GCHATLISTEN | GR_RIGHT_GCHATSPEAK);
...
bool Guild::DelMember(ObjectGuid guid, bool isDisbanding)
{
    ...
    // Used by Eluna
#ifdef ENABLE_ELUNA
    sEluna->OnRemoveMember(this, player, isDisbanding); // IsKicked not a part of Firelands, implement?
#endif /* ENABLE_ELUNA */
...
void Guild::LoadGuildEventLogFromDB()
{
    ...
    do
    {
        ...
        // events with same timestamp can appear when there is lag, and we naively suppose that the server isn't laggy
...
//    sEluna->OnMemberWitdrawMoney(this, player, amount, false); // IsRepair not a part of the core, implement?
//#endif
