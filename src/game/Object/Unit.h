 ...
 * \file
 */
#ifndef FIRELANDS_H_UNIT
#define FIRELANDS_H_UNIT
...
class Unit : public WorldObject
{
    public:
         ...
         * \see Firelands::AnyUnfriendlyUnitInObjectRangeCheck
         * \see Firelands::UnitListSearcher
         ...
         * \see Firelands::AnyFriendlyUnitInObjectRangeCheck
         * \see Firelands::UnitListSearcher
         * \see Cell::VisitAllObjects
         */
