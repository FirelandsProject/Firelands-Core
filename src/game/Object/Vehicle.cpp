 ...
 *
 * @file Vehicle.cpp
 * This file contains the code needed for CFirelands to support vehicles
...
void VehicleInfo::Board(Unit* passenger, uint8 seat)
{
    ...
    /*if (TransportInfo* transportInfo = passenger->GetTransportInfo())
    {
        ...
        FIRELANDS_ASSERT(transporter->GetObjectGuid().IsMOTransport());
...
void VehicleInfo::SwitchSeat(Unit* passenger, uint8 seat)
{
    ...
    FIRELANDS_ASSERT(itr != m_passengers.end());
