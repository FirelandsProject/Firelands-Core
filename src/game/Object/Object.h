...
#ifndef FIRELANDS_H_OBJECT
#define FIRELANDS_H_OBJECT
...
class Object
{
    public:
        ...
        {
            FIRELANDS_ASSERT(index < m_valuesCount || PrintIndexError(index , false));
        ...
        {
            FIRELANDS_ASSERT(index + 1 < m_valuesCount || PrintIndexError(index , false));
...
class WorldObject : public Object
{
    ...
    public:
        ...
        void MonsterText(FirelandsStringLocale const* textData, Unit const* target) const;
        ...
        void SetMap(Map* map);
        Map* GetMap() const { FIRELANDS_ASSERT(m_currMap); return m_currMap; }
