...
TotemAI::UpdateAI(const uint32 /*diff*/)
{
        ...
        m_creature->IsFriendlyTo(victim) || !victim->IsVisibleForOrDetect(m_creature, m_creature, false))
    {
        ...
        Firelands::NearestAttackableUnitInObjectRangeCheck u_check(m_creature, m_creature, max_range);
        Firelands::UnitLastSearcher<Firelands::NearestAttackableUnitInObjectRangeCheck> checker(victim, u_check);
