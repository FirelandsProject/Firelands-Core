...
#ifndef FIRELANDS_H_PLAYER
#define FIRELANDS_H_PLAYER
...
struct EnchantDuration
{
    ...
    EnchantDuration(Item* _item, EnchantmentSlot _slot, uint32 _leftduration) : item(_item), slot(_slot), leftduration(_leftduration) { FIRELANDS_ASSERT(item); };
