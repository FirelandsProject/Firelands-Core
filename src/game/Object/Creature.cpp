...
void Creature::DoFleeToGetAssistance()
{
    ...
    if (radius > 0)
    {
        ...
        Firelands::CreatureLastSearcher<Firelands::NearestAssistCreatureInCreatureRangeCheck> searcher(pCreature, u_check);
...
void Creature::CallForHelp(float fRadius)
{
    ...
    Firelands::CallOfHelpCreatureInRangeDo u_do(this, getVictim(), fRadius);
...
void Creature::GetRespawnCoord(float& x, float& y, float& z, float* ori, float* dist) const
{
    ...
    FIRELANDS_ASSERT(Firelands::IsValidMapCoord(x, y, z) || PrintCoordinatesError(x, y, z, "respawn"));
}
