...
#ifndef FIRELANDS_H_SQLOPERATIONS
#define FIRELANDS_H_SQLOPERATIONS
...
class SqlPlainRequest : public SqlOperation
{
    ...
    public:
         ...
         * @param sql
         */
        SqlPlainRequest(const char* sql) : m_sql(firelands_strdup(sql)) {}
        /**
         * @brief
         *
         */
 ...
 *
 */
class SqlResultQueue : public ACE_Based::LockedQueue<Firelands::IQueryCallback* , ACE_Thread_Mutex>
{
    public:
        /**
         * @brief
...
class SqlQuery : public SqlOperation
{
    private:
        const char* m_sql; /**< TODO */
        Firelands::IQueryCallback* m_callback; /**< TODO */
    ...
    public:
         ...
         * @param queue
         */
        SqlQuery(const char* sql, Firelands::IQueryCallback* callback, SqlResultQueue* queue)
            : m_sql(firelands_strdup(sql)), m_callback(callback), m_queue(queue) {}
        /**
         * @brief
         *
         */
...
class SqlQueryHolder
{
    ...
    public:
         ...
         * @return bool
         */
        bool Execute(Firelands::IQueryCallback* callback, SqlDelayThread* thread, SqlResultQueue* queue);
};
...
class SqlQueryHolderEx : public SqlOperation
{
    ...
    public:
         ...
         * @param queue
         */
        SqlQueryHolderEx(SqlQueryHolder* holder, Firelands::IQueryCallback* callback, SqlResultQueue* queue)
