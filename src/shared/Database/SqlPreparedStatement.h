...
class SqlStmtFieldData
{
    public:
         ...
         * @return bool
         */
        bool toBool() const { FIRELANDS_ASSERT(m_type == FIELD_BOOL); return static_cast<bool>(m_binaryData.ui8); }
        /**
         * @brief getter
         *
         * @return uint8
         */
        uint8 toUint8() const { FIRELANDS_ASSERT(m_type == FIELD_UI8); return m_binaryData.ui8; }
        /**
         * @brief getter
         *
         * @return int8
         */
        int8 toInt8() const { FIRELANDS_ASSERT(m_type == FIELD_I8); return m_binaryData.i8; }
        /**
         * @brief getter
         *
         * @return uint16
         */
        uint16 toUint16() const { FIRELANDS_ASSERT(m_type == FIELD_UI16); return m_binaryData.ui16; }
        /**
         * @brief getter
         *
         * @return int16
         */
        int16 toInt16() const { FIRELANDS_ASSERT(m_type == FIELD_I16); return m_binaryData.i16; }
        /**
         * @brief getter
         *
         * @return uint32
         */
        uint32 toUint32() const { FIRELANDS_ASSERT(m_type == FIELD_UI32); return m_binaryData.ui32; }
        /**
         * @brief getter
         *
         * @return int32
         */
        int32 toInt32() const { FIRELANDS_ASSERT(m_type == FIELD_I32); return m_binaryData.i32; }
        /**
         * @brief getter
         *
         * @return uint64
         */
        uint64 toUint64() const { FIRELANDS_ASSERT(m_type == FIELD_UI64); return m_binaryData.ui64; }
        /**
         * @brief getter
         *
         * @return int64
         */
        int64 toInt64() const { FIRELANDS_ASSERT(m_type == FIELD_I64); return m_binaryData.i64; }
        /**
         * @brief getter
         *
         * @return float
         */
        float toFloat() const { FIRELANDS_ASSERT(m_type == FIELD_FLOAT); return m_binaryData.f; }
        /**
         * @brief getter
         *
         * @return double
         */
        double toDouble() const { FIRELANDS_ASSERT(m_type == FIELD_DOUBLE); return m_binaryData.d; }
        /**
         * @brief getter
         *
         * @return const char
         */
        const char* toStr() const { FIRELANDS_ASSERT(m_type == FIELD_STRING); return m_szStringData.c_str(); }
