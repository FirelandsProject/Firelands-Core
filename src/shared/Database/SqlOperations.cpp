...
void SqlResultQueue::Update()
{
    ...
    Firelands::IQueryCallback* callback = NULL;
    while (next(callback))
    {
        callback->Execute();
        delete callback;
...
bool SqlQueryHolder::Execute(Firelands::IQueryCallback* callback, SqlDelayThread* thread, SqlResultQueue* queue)
{
...
bool SqlQueryHolder::SetQuery(size_t index, const char* sql)
{
    ...
    m_queries[index] = SqlResultPair(firelands_strdup(sql), (QueryResult*)NULL);
    return true;
}
