 ...
 *
 */
class Log : public Firelands::Singleton<Log, Firelands::ClassLevelLockable<Log, ACE_Thread_Mutex> >
{
        friend class Firelands::OperatorNew<Log>;
        /**
         * @brief
         *
         */
...
#define sLog Firelands::Singleton<Log>::Instance()
