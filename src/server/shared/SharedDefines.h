...
#ifndef _FIRELANDS_SHAREDDEFINES_H
#define _FIRELANDS_SHAREDDEFINES_H
...
{
    struct FC_SHARED_API CurrentServerProcessHolder
    {
...
#define THIS_SERVER_PROCESS (Firelands::Impl::CurrentServerProcessHolder::type())
