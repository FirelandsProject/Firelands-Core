...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_INVITE");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_INVITE_RESPONSE");
    ...
    if (accept)
    {
        ...
        {
            LOG_ERROR("network.opcode", "HandleGroupAcceptOpcode: player %s(%d) tried to accept an invite to his own group", GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
            return;
        }
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_UNINVITE_GUID");
    ...
    {
        LOG_ERROR("network.opcode", "WorldSession::HandleGroupUninviteGuidOpcode: leader %s(%d) tried to uninvite himself from the group.",
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_UNINVITE");
    ...
    {
        LOG_ERROR("network.opcode", "WorldSession::HandleGroupUninviteOpcode: leader %s(%d) tried to uninvite himself from the group.",
            GetPlayer()->GetName().c_str(), GetPlayer()->GetGUIDLow());
        return;
    }
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_SET_LEADER");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_SET_ROLES");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_ROLL_POLL_BEGIN");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_DISBAND");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_LOOT_METHOD");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received MSG_MINIMAP_PING");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received MSG_RANDOM_ROLL");
    ...
    //LOG_DEBUG("misc", "ROLL: MIN: %u, MAX: %u, ROLL: %u", minimum, maximum, roll);
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received MSG_RAID_TARGET_UPDATE");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_RAID_CONVERT");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_CHANGE_SUB_GROUP");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_SWAP_SUB_GROUP");
    std::string unk1;
    std::string unk2;
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GROUP_ASSISTANT_LEADER");
...
{
    LOG_DEBUG("network.opcode", "WORLD: CMSG_SET_EVERYONE_IS_ASSISTANT ");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received MSG_PARTY_ASSIGNMENT");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received MSG_RAID_READY_CHECK");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_REQUEST_PARTY_MEMBER_STATS");
    uint64 guid;
    recvData >> guid;
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_OPT_OUT_OF_LOOT");
    ...
    {
        if (passOnLoot)
            LOG_ERROR("network.opcode", "CMSG_OPT_OUT_OF_LOOT value<>0 for not-loaded character!");
        return;
    }
...
void WorldSession::HandleClearRaidMarker(WorldPacket& recvData)
{
    ...
    Group* group = GetPlayer()->GetGroup();
    LOG_DEBUG("network.opcode", "Group::HandleClearRaidMarker Slots: %u",slots);
