...
void WorldSession::HandleGuildQueryOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_QUERY [%s]: Guild: %u Target: %u",
...
void WorldSession::HandleGuildRemoveOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_REMOVE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(playerGuid));
...
void WorldSession::HandleGuildPromoteOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_PROMOTE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(targetGuid));
...
void WorldSession::HandleGuildDemoteOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_DEMOTE [%s]: Target: %u", GetPlayerInfo().c_str(), GUID_LOPART(targetGuid));
...
void WorldSession::HandleGuildAssignRankOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_ASSIGN_MEMBER_RANK [%s]: Target: %u Rank: %u, Issuer: %u",
...
void WorldSession::HandleGuildSetNoteOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_SET_NOTE [%s]: Target: %u, Note: %s, Public: %u",
...
void WorldSession::HandleGuildQueryRanksOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_QUERY_RANKS [%s]: Guild: %u",
...
void WorldSession::HandleSaveGuildEmblemOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "MSG_SAVE_GUILD_EMBLEM [%s]: Guid: [{} "
...
{
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_MONEY_WITHDRAWN [%s]", GetPlayerInfo().c_str());
...
{
    LOG_DEBUG("guild", "CMSG_GUILD_PERMISSIONS [%s]", GetPlayerInfo().c_str());
...
void WorldSession::HandleGuildBankerActivate(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANKER_ACTIVATE [%s]: Go: [{}] AllSlots: %u"
...
void WorldSession::HandleGuildBankQueryTab(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_QUERY_TAB [%s]: Go: [{}], TabId: %u, AllSlots: %u"
...
void WorldSession::HandleGuildBankDepositMoney(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_DEPOSIT_MONEY [%s]: Go: [{}], money: {} ",
...
void WorldSession::HandleGuildBankWithdrawMoney(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_WITHDRAW_MONEY [%s]: Go: [{}], money: {} ",
        GetPlayerInfo().c_str(), guid, money);
...
void WorldSession::HandleGuildBankBuyTab(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_BUY_TAB [%s]: Go: [{}], TabId: %u", GetPlayerInfo().c_str(), guid, tabId);
...
void WorldSession::HandleGuildBankUpdateTab(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("guild", "CMSG_GUILD_BANK_UPDATE_TAB [%s]: Go: [{}], TabId: %u, Name: %s, Icon: %s"
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_QUERY_GUILD_XP");
    ...
    LOG_DEBUG("guild", "CMSG_QUERY_GUILD_XP [%s]: Guild: %u", GetPlayerInfo().c_str(), GUID_LOPART(guildGuid));
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_GUILD_REQUEST_PARTY_STATE");
...
void WorldSession::HandleGuildSwitchRankOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG("network.opcode","WORLD: Received CMSG_GUILD_SWITCH_RANK rank %u up %u", rankId, up);
...
{
    LOG_DEBUG("guild", "CMSG_GUILD_CHANGE_NAME_REQUEST");

    //    uint32 length = recvPacket.ReadBits(12);
    //  std::string info = recvPacket.ReadString(length);

    //    LOG_DEBUG("guild", "CMSG_GUILD_CHANGE_NAME_REQUEST [%s]: %s", GetPlayerInfo().c_str(), info.c_str());
...
{
    LOG_DEBUG("guild", "CMSG_QUERY_GUILD_MEMBER_RECIPES");
    ...
    if (Guild* guild = GetPlayer()->GetGuild())
    {
        LOG_DEBUG("guild", "SMSG_GUILD_MEMBER_RECIPES");
...
{
    LOG_DEBUG("guild", "CMSG_QUERY_GUILD_MEMBERS_FOR_RECIPE");
...
void WorldSession::HandleGuildMemberByRecipes(uint32 skillId)
{
    ...
    LOG_DEBUG("guild", "SMSG_GUILD_MEMBERS_FOR_RECIPE");
...
{
    LOG_DEBUG("guild", "CMSG_QUERY_GUILD_RECIPES");
