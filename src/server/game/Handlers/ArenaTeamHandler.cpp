...
{
    LOG_DEBUG("network.opcode", "MSG_INSPECT_ARENA_TEAMS");

    uint64 guid;
    recvData >> guid;
    LOG_DEBUG("network.opcode", "Inspect Arena stats (GUID: %u TypeId: %u)", GUID_LOPART(guid), GuidHigh2TypeId(GUID_HIPART(guid)));
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_ARENA_TEAM_QUERY");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_ARENA_TEAM_ROSTER");
...
{
    LOG_DEBUG("network.opcode", "WORLD: Received CMSG_ARENA_TEAM_CREATE");
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_INVITE");
    ...
    LOG_DEBUG("network.opcode", "WORLD: Sent SMSG_ARENA_TEAM_INVITE");
}

void WorldSession::HandleArenaTeamAcceptOpcode(WorldPacket & /*recvData*/)
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_ACCEPT");                // empty opcode
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_DECLINE");               // empty opcode
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_LEAVE");
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_DISBAND");
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_REMOVE");
...
{
    LOG_DEBUG("network.opcode", "CMSG_ARENA_TEAM_LEADER");
