...
void WorldSession::HandleCalendarGetCalendar(WorldPacket& /*recvData*/)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GET_CALENDAR [" UI64FMTD "]", guid);
...
{
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GUILD_FILTER [" UI64FMTD "]", _player->GetGUID());
...
{
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_ARENA_TEAM [" UI64FMTD "]", _player->GetGUID());
...
void WorldSession::HandleCalendarUpdateEvent(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_UPDATE_EVENT [" UI64FMTD "] EventId [" UI64FMTD
...
void WorldSession::HandleCalendarCopyEvent(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_COPY_EVENT [" UI64FMTD "], EventId [" UI64FMTD
...
void WorldSession::HandleCalendarEventSignup(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_SIGNUP [" UI64FMTD "] EventId [" UI64FMTD "] Tentative %u", guid, eventId, tentative);
...
void WorldSession::HandleCalendarEventRsvp(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_RSVP [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarEventStatus(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_STATUS [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarEventModeratorStatus(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_MODERATOR_STATUS [" UI64FMTD "] EventId ["
        UI64FMTD "] ownerInviteId [" UI64FMTD "], Invitee ([" UI64FMTD "] id: ["
...
void WorldSession::HandleCalendarComplain(WorldPacket& recvData)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_COMPLAIN [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarGetNumPending(WorldPacket& /*recvData*/)
{
    ...
    LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GET_NUM_PENDING: [" UI64FMTD
...
void WorldSession::SendCalendarRaidLockoutUpdated(InstanceSave const* save)
{
    ...
    uint64 guid = _player->GetGUID();
    LOG_DEBUG("network.opcode", "SMSG_CALENDAR_RAID_LOCKOUT_UPDATED [" UI64FMTD
