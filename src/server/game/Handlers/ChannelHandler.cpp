...
void WorldSession::HandleLeaveChannel(WorldPacket &recvPacket) {
  ...
  if (ChannelMgr *cMgr = ChannelMgr::forTeam(GetPlayer()->GetTeam())) {
    if (Channel *channel =
            ChannelMgr::GetChannelForPlayerByNamePart(channelName, GetPlayer()))
...
void WorldSession::HandleChannelList(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system", "%s %s Channel: %s",
            recvPacket.GetOpcode() == CMSG_CHAT_CHANNEL_DISPLAY_LIST
...
void WorldSession::HandleChannelPassword(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_PASSWORD %s Channel: %s, Password: %s",
...
void WorldSession::HandleChannelSetOwner(WorldPacket &recvPacket) {
  ...
  recvPacket >> targetName;
  std::string channelName;
  recvPacket >> channelName;

  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_SET_OWNER %s Channel: %s, Target: %s",
...
void WorldSession::HandleChannelModerator(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_MODERATOR %s Channel: %s, Target: %s",
            GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmoderator(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_UNMODERATOR %s Channel: %s, Target: %s",
            GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelUnmute(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_UNMUTE %s Channel: %s, Target: %s",
            GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleChannelInvite(WorldPacket &recvPacket) {
  ...
  LOG_DEBUG("chat.system",
            "CMSG_CHAT_CHANNEL_INVITE %s Channel: %s, Target: %s",
            GetPlayerInfo().c_str(), channelName.c_str(), targetName.c_str());
...
void WorldSession::HandleGetChannelMemberCount(WorldPacket &recvPacket) {
  ...
  if (Channel *channel =
          ChannelMgr::GetChannelForPlayerByNamePart(channelName, GetPlayer())) {
    LOG_DEBUG(
        "chat.system", "SMSG_CHANNEL_MEMBER_COUNT %s Channel: %s Count: %u",
...
void WorldSession::HandleSetChannelWatch(WorldPacket &recvPacket) {
  ...
  /*
  if (Channel* channel = ChannelMgr::GetChannelForPlayerByNamePart(channelName,
  GetPlayer())) channel->JoinNotify(GetPlayer());
  */
}
