...
template class FC_GAME_API ScriptRegistry<BGScript>;
...
template class FC_GAME_API ScriptRegistry<CommandSC>;
...
template class FC_GAME_API ScriptRegistry<LootScript>;
...
template class FC_GAME_API ScriptRegistry<SpellSC>;
