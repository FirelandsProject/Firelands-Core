...
WorldPacket const *WorldPackets::Party::PartyInvite::Write() {
  _worldPacket.WriteBit(
      MustBeBNetFriend); // This bit automatically declines party invites so
                         // it's probably bnet friends parental control stuff
