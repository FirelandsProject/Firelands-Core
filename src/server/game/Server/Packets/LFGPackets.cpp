...
void WorldPackets::LFG::LFGSetRoles::Read() { _worldPacket >> RolesDesired; }
...
void WorldPackets::LFG::LFGBootPlayerVote::Read() { _worldPacket >> Vote; }

void WorldPackets::LFG::LFGTeleport::Read() { _worldPacket >> TeleportOut; }
...
ByteBuffer &operator<<(
  ...
  ItemTemplate const *item =
      sObjectMgr->GetItemTemplate(playerQuestRewardItem.ItemID);
...
ByteBuffer &operator<<(ByteBuffer &data,
                       WorldPackets::LFG::LfgPlayerQuestRewardCurrency const
                           &playerQuestRewardCurrency) {
...
operator<<(ByteBuffer &data,
  ...
  data << uint8(playerQuestReward.Item.size() +
                playerQuestReward.Currency.size());

  for (WorldPackets::LFG::LfgPlayerQuestRewardCurrency const &currency :
       playerQuestReward.Currency)
    data << currency;

  for (WorldPackets::LFG::LfgPlayerQuestRewardItem const &item :
       playerQuestReward.Item)
    data << item;
...
ByteBuffer &operator<<(ByteBuffer &data,
                       WorldPackets::LFG::LFGRoleCheckUpdateMember const
...
ByteBuffer &
operator<<(ByteBuffer &data,
           WorldPackets::LFG::LFGJoinBlackListSlot const &lfgBlackListSlot) {
  data << uint32(lfgBlackListSlot.Reason);
  data << uint32(lfgBlackListSlot.SubReason1);
  data << uint32(lfgBlackListSlot.SubReason2);
  data << uint32(lfgBlackListSlot.Slot);
...
ByteBuffer &operator<<(ByteBuffer &data,
                       WorldPackets::LFG::LFGJoinBlackList const &blackList) {
...
operator<<(ByteBuffer &data,
  ...
  ItemTemplate const *item =
      !lfgPlayerRewards.IsCurrency
          ? sObjectMgr->GetItemTemplate(lfgPlayerRewards.RewardItem)
          : nullptr;
