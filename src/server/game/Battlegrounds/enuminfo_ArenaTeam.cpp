...
namespace Firelands::Impl::EnumUtilsImpl
{
    ...
    \******************************************************************/
    template <>
    FC_API_EXPORT EnumText EnumUtils<ArenaTeamTypes>::ToString(ArenaTeamTypes value)
    {
        switch (value)
        {
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<ArenaTeamTypes>::Count() { return 3; }

    template <>
    FC_API_EXPORT ArenaTeamTypes EnumUtils<ArenaTeamTypes>::FromIndex(size_t index)
    {
        switch (index)
        {
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<ArenaTeamTypes>::ToIndex(ArenaTeamTypes value)
    {
        switch (value)
        {
