...
BfWGCoordGY const WGGraveyard[BATTLEFIELD_WG_GRAVEYARD_MAX] = {
    {{5104.750f, 2300.940f, 368.579f, 0.733038f},
     1329,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_NE,
     TEAM_NEUTRAL},
    {{5099.120f, 3466.036f, 368.484f, 5.317802f},
     1330,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_NW,
     TEAM_NEUTRAL},
    {{4314.648f, 2408.522f, 392.642f, 6.268125f},
     1333,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_SE,
     TEAM_NEUTRAL},
    {{4331.716f, 3235.695f, 390.251f, 0.008500f},
     1334,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_SW,
     TEAM_NEUTRAL},
    {{5537.986f, 2897.493f, 517.057f, 4.819249f},
     1285,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_KEEP,
     TEAM_NEUTRAL},
    {{5032.454f, 3711.382f, 372.468f, 3.971623f},
     1331,
     BATTLEFIELD_WG_GOSSIPTEXT_GY_HORDE,
     TEAM_HORDE},
    {{5140.790f, 2179.120f, 390.950f, 1.972220f},
     1332,
...
uint32 const WintergraspFaction[] = {
    FACTION_ALLIANCE_GENERIC_WG, FACTION_HORDE_GENERIC_WG, FACTION_FRIENDLY};

Position const WintergraspStalkerPos = {4948.985f, 2937.789f, 550.5172f,
                                        1.815142f};

Position const WintergraspRelicPos = {5440.379f, 2840.493f, 430.2816f,
                                      -1.832595f};
...
WintergraspBuildingSpawnData const WGGameObjectBuilding[WG_MAX_OBJ] = {
    ...
    // Entry  WS      X          Y          Z           O                rX   rY
    // rZ             rW             Type
    {190219,
     3749,
     {5371.457f, 3047.472f, 407.5710f, 3.14159300f},
     {0.f, 0.f, -1.000000000f, 0.00000000f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190220,
     3750,
     {5331.264f, 3047.105f, 407.9228f, 0.05235888f},
     {0.f, 0.f, 0.026176450f, 0.99965730f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191795,
     3764,
     {5385.841f, 2909.490f, 409.7127f, 0.00872424f},
     {0.f, 0.f, 0.004362106f, 0.99999050f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191796,
     3772,
     {5384.452f, 2771.835f, 410.2704f, 3.14159300f},
     {0.f, 0.f, -1.000000000f, 0.00000000f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191799,
     3762,
     {5371.436f, 2630.610f, 408.8163f, 3.13285800f},
     {0.f, 0.f, 0.999990500f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191800,
     3766,
     {5301.838f, 2909.089f, 409.8661f, 0.00872424f},
     {0.f, 0.f, 0.004362106f, 0.99999050f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191801,
     3770,
     {5301.063f, 2771.411f, 409.9014f, 3.14159300f},
     {0.f, 0.f, -1.000000000f, 0.00000000f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191802,
     3751,
     {5280.197f, 2995.583f, 408.8249f, 1.61442800f},
     {0.f, 0.f, 0.722363500f, 0.69151360f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191803,
     3752,
     {5279.136f, 2956.023f, 408.6041f, 1.57079600f},
     {0.f, 0.f, 0.707106600f, 0.70710690f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191804,
     3767,
     {5278.685f, 2882.513f, 409.5388f, 1.57079600f},
     {0.f, 0.f, 0.707106600f, 0.70710690f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191806,
     3769,
     {5279.502f, 2798.945f, 409.9983f, 1.57079600f},
     {0.f, 0.f, 0.707106600f, 0.70710690f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191807,
     3759,
     {5279.937f, 2724.766f, 409.9452f, 1.56207000f},
     {0.f, 0.f, 0.704014800f, 0.71018530f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191808,
     3760,
     {5279.601f, 2683.786f, 409.8488f, 1.55334100f},
     {0.f, 0.f, 0.700908700f, 0.71325110f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191809,
     3761,
     {5330.955f, 2630.777f, 409.2826f, 3.13285800f},
     {0.f, 0.f, 0.999990500f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190369,
     3753,
     {5256.085f, 2933.963f, 409.3571f, 3.13285800f},
     {0.f, 0.f, 0.999990500f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190370,
     3758,
     {5257.463f, 2747.327f, 409.7427f, -3.13285800f},
     {0.f, 0.f, -0.999990500f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190371,
     3754,
     {5214.960f, 2934.089f, 409.1905f, -0.00872424f},
     {0.f, 0.f, -0.004362106f, 0.99999050f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190372,
     3757,
     {5215.821f, 2747.566f, 409.1884f, -3.13285800f},
     {0.f, 0.f, -0.999990500f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190374,
     3755,
     {5162.273f, 2883.043f, 410.2556f, 1.57952200f},
     {0.f, 0.f, 0.710185100f, 0.70401500f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {190376,
     3756,
     {5163.724f, 2799.838f, 409.2270f, 1.57952200f},
     {0.f, 0.f, 0.710185100f, 0.70401500f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    ...
    {190221,
     3711,
     {5281.154f, 3044.588f, 407.8434f, 3.115388f},
     {0.f, 0.f, 0.9999142f, 0.013101960f},
     BATTLEFIELD_WG_OBJECTTYPE_KEEP_TOWER}, // NW
    {190373,
     3713,
     {5163.757f, 2932.228f, 409.1904f, 3.124123f},
     {0.f, 0.f, 0.9999619f, 0.008734641f},
     BATTLEFIELD_WG_OBJECTTYPE_KEEP_TOWER}, // SW
    {190377,
     3714,
     {5166.397f, 2748.368f, 409.1884f, -1.570796f},
     {0.f, 0.f, -0.7071066f, 0.707106900f},
     BATTLEFIELD_WG_OBJECTTYPE_KEEP_TOWER}, // SE
    {190378,
     3712,
     {5281.192f, 2632.479f, 409.0985f, -1.588246f},
     {0.f, 0.f, -0.7132492f, 0.700910500f},
     BATTLEFIELD_WG_OBJECTTYPE_KEEP_TOWER}, // NE

    // Wall (with passage) (Not spawned in db)
    {191797,
     3765,
     {5343.290f, 2908.860f, 409.5757f, 0.00872424f},
     {0.f, 0.f, 0.004362106f, 0.9999905f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191798,
     3771,
     {5342.719f, 2771.386f, 409.6249f, 3.14159300f},
     {0.f, 0.f, -1.000000000f, 0.0000000f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},
    {191805,
     3768,
     {5279.126f, 2840.797f, 409.7826f, 1.57952200f},
     {0.f, 0.f, 0.710185100f, 0.7040150f},
     BATTLEFIELD_WG_OBJECTTYPE_WALL},

    // South tower (Not spawned in db)
    {190356,
     3704,
     {4557.173f, 3623.943f, 395.8828f, 1.675516f},
     {0.f, 0.f, 0.7431450f, 0.669130400f},
     BATTLEFIELD_WG_OBJECTTYPE_TOWER}, // W
    {190357,
     3705,
     {4398.172f, 2822.497f, 405.6270f, -3.124123f},
     {0.f, 0.f, -0.9999619f, 0.008734641f},
     BATTLEFIELD_WG_OBJECTTYPE_TOWER}, // S
    {190358,
     3706,
     {4459.105f, 1944.326f, 434.9912f, -2.002762f},
     {0.f, 0.f, -0.8422165f, 0.539139500f},
     BATTLEFIELD_WG_OBJECTTYPE_TOWER}, // E

    // Door of forteress (Not spawned in db)
    {GO_WINTERGRASP_FORTRESS_GATE,
     3763,
     {5162.991f, 2841.232f, 410.1892f, -3.132858f},
     {0.f, 0.f, -0.9999905f, 0.00436732f},
     BATTLEFIELD_WG_OBJECTTYPE_DOOR},

    // Last door (Not spawned in db)
    {GO_WINTERGRASP_VAULT_GATE,
     3773,
     {5397.108f, 2841.54f, 425.9014f, 3.141593f},
     {0.f, 0.f, -1.f, 0.f},
...
WintergraspGameObjectData const WGPortalDefenderData[WG_MAX_TELEPORTER] = {
    // Player teleporter
    {{5153.408f, 2901.349f, 409.1913f, -0.06981169f},
     {0.f, 0.f, -0.03489876f, 0.9993908f},
     190763,
     191575},
    {{5268.698f, 2666.421f, 409.0985f, -0.71558490f},
     {0.f, 0.f, -0.35020730f, 0.9366722f},
     190763,
     191575},
    {{5197.050f, 2944.814f, 409.1913f, 2.33874000f},
     {0.f, 0.f, 0.92050460f, 0.3907318f},
     190763,
     191575},
    {{5196.671f, 2737.345f, 409.1892f, -2.93213900f},
     {0.f, 0.f, -0.99452110f, 0.1045355f},
     190763,
     191575},
    {{5314.580f, 3055.852f, 408.8620f, 0.54105060f},
     {0.f, 0.f, 0.26723770f, 0.9636307f},
     190763,
     191575},
    {{5391.277f, 2828.094f, 418.6752f, -2.16420600f},
     {0.f, 0.f, -0.88294700f, 0.4694727f},
     190763,
     191575},
    {{5153.931f, 2781.671f, 409.2455f, 1.65806200f},
     {0.f, 0.f, 0.73727700f, 0.6755905f},
     190763,
     191575},
    {{5311.445f, 2618.931f, 409.0916f, -2.37364400f},
     {0.f, 0.f, -0.92718320f, 0.3746083f},
     190763,
     191575},
    {{5269.208f, 3013.838f, 408.8276f, -1.76278200f},
     {0.f, 0.f, -0.77162460f, 0.6360782f},
     190763,
     191575},

    {{5401.634f, 2853.667f, 418.6748f, 2.63544400f},
     {0.f, 0.f, 0.96814730f, 0.2503814f},
     192819,
     192819}, // return portal inside fortress, neutral
              // Vehicle teleporter
    {{5314.515f, 2703.687f, 408.5502f, -0.89011660f},
     {0.f, 0.f, -0.43051050f, 0.9025856f},
     192951,
     192951},
    {{5316.252f, 2977.042f, 408.5385f, -0.82030330f},
     {0.f, 0.f, -0.39874840f, 0.9170604f},
     192951,
     192951}};
...
struct WintergraspTowerData {
  ...
  std::vector<WintergraspGameObjectData>
      GameObject; // Gameobject position and entry (Horde/Alliance)

  // Creature: Turrets and Guard /// @todo: Killed on Tower destruction ? Tower
  // damage ? Requires confirming
...
WintergraspTowerData const AttackTowers[WG_MAX_ATTACKTOWERS] = {
    ...
    {190356,
     {
         {{4559.113f, 3606.216f, 419.9992f, 4.799657f},
          {0.f, 0.f, -0.67558960f, 0.73727790f},
          192488,
          192501}, // Flag on tower
         {{4539.420f, 3622.490f, 420.0342f, 3.211419f},
          {0.f, 0.f, -0.99939060f, 0.03490613f},
          192488,
          192501}, // Flag on tower
         {{4555.258f, 3641.648f, 419.9740f, 1.675514f},
          {0.f, 0.f, 0.74314400f, 0.66913150f},
          192488,
          192501}, // Flag on tower
         {{4574.872f, 3625.911f, 420.0792f, 0.087266f},
          {0.f, 0.f, 0.04361916f, 0.99904820f},
          192488,
          192501}, // Flag on tower
         {{4433.899f, 3534.142f, 360.2750f, 4.433136f},
          {0.f, 0.f, -0.79863550f, 0.60181500f},
          192269,
          192278}, // Flag near workshop
         {{4572.933f, 3475.519f, 363.0090f, 1.422443f},
          {0.f, 0.f, 0.65275960f, 0.75756520f},
          192269,
          192277} // Flag near bridge
     },
     {
    ...
    {190357,
     {
         {{4416.004f, 2822.666f, 429.8512f, 6.2657330f},
          {0.f, 0.f, -0.00872612f, 0.99996190f},
          192488,
          192501}, // Flag on tower
         {{4398.819f, 2804.698f, 429.7920f, 4.6949370f},
          {0.f, 0.f, -0.71325020f, 0.70090960f},
          192488,
          192501}, // Flag on tower
         {{4387.622f, 2719.566f, 389.9351f, 4.7385700f},
          {0.f, 0.f, -0.69779010f, 0.71630230f},
          192366,
          192414}, // Flag near tower
         {{4464.124f, 2855.453f, 406.1106f, 0.8290324f},
          {0.f, 0.f, 0.40274720f, 0.91531130f},
          192366,
          192429}, // Flag near tower
         {{4526.457f, 2810.181f, 391.1997f, 3.2899610f},
          {0.f, 0.f, -0.99724960f, 0.07411628f},
          192269,
    ...
    {190358,
     {
         {{4466.793f, 1960.418f, 459.1437f, 1.151916f},
          {0.f, 0.f, 0.5446386f, 0.8386708f},
          192488,
          192501}, // Flag on tower
         {{4475.351f, 1937.031f, 459.0702f, 5.846854f},
          {0.f, 0.f, -0.2164392f, 0.9762961f},
          192488,
          192501}, // Flag on tower
         {{4451.758f, 1928.104f, 459.0759f, 4.276057f},
          {0.f, 0.f, -0.8433914f, 0.5372996f},
          192488,
          192501}, // Flag on tower
         {{4442.987f, 1951.898f, 459.0930f, 2.740162f},
          {0.f, 0.f, 0.9799242f, 0.1993704f},
          192488,
          192501} // Flag on tower
     },
     {
         ...
         {{4494.580078f, 1943.760010f, 435.627014f, 6.195920f},
          BATTLEFIELD_WG_NPC_GUARD_H,
          BATTLEFIELD_WG_NPC_GUARD_A}, // Standing Guard
         {{4450.149902f, 1897.579956f, 435.045013f, 4.398230f},
          BATTLEFIELD_WG_NPC_GUARD_H,
          BATTLEFIELD_WG_NPC_GUARD_A}, // Standing Guard
         {{4428.870117f, 1906.869995f, 432.648010f, 3.996800f},
          BATTLEFIELD_WG_NPC_GUARD_H,
          BATTLEFIELD_WG_NPC_GUARD_A} // Standing Guard
     }}};
...
bool BattlefieldWG::SetupBattlefield() {
  ...
  SetData(BATTLEFIELD_WG_DATA_WON_A,
          uint32(sWorld->getWorldState(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_A)));
  SetData(BATTLEFIELD_WG_DATA_DEF_A,
          uint32(sWorld->getWorldState(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_A)));
  SetData(BATTLEFIELD_WG_DATA_WON_H,
          uint32(sWorld->getWorldState(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_H)));
  SetData(BATTLEFIELD_WG_DATA_DEF_H,
          uint32(sWorld->getWorldState(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_H)));
  ...
  for (uint8 i = 0; i < WG_MAX_TURRET; i++) {
    ...
    if (Creature *creature =
            SpawnCreature(NPC_WINTERGRASP_TOWER_CANNON, towerCannonPos)) {
  ...
  for (uint8 i = 0; i < WG_MAX_OBJ; i++) {
    if (GameObject *go = SpawnGameObject(WGGameObjectBuilding[i].entry,
                                         WGGameObjectBuilding[i].pos,
                                         WGGameObjectBuilding[i].rot)) {
      BfWGGameObjectBuilding *b =
          new BfWGGameObjectBuilding(this, WGGameObjectBuilding[i].type,
  ...
  for (uint8 i = 0; i < WG_MAX_TELEPORTER; ++i) {
    ...
    if (GameObject *go = SpawnGameObject(teleporter.AllianceEntry,
                                         teleporter.Pos, teleporter.Rot)) {
      DefenderPortalList[TEAM_ALLIANCE].push_back(go->GetGUID());
      go->SetRespawnTime(GetDefenderTeam() == TEAM_ALLIANCE
                             ? RESPAWN_IMMEDIATELY
                             : RESPAWN_ONE_DAY);
    }

    if (GameObject *go = SpawnGameObject(teleporter.HordeEntry, teleporter.Pos,
                                         teleporter.Rot)) {
      DefenderPortalList[TEAM_HORDE].push_back(go->GetGUID());
      go->SetRespawnTime(GetDefenderTeam() == TEAM_HORDE ? RESPAWN_IMMEDIATELY
                                                         : RESPAWN_ONE_DAY);
    }
  }
...
bool BattlefieldWG::Update(uint32 diff) {
  ...
  if (m_saveTimer <= diff) {
    ...
    sWorld->setWorldState(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_A,
                          GetData(BATTLEFIELD_WG_DATA_WON_A));
    sWorld->setWorldState(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_A,
                          GetData(BATTLEFIELD_WG_DATA_DEF_A));
    sWorld->setWorldState(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_H,
                          GetData(BATTLEFIELD_WG_DATA_WON_H));
    sWorld->setWorldState(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_H,
                          GetData(BATTLEFIELD_WG_DATA_DEF_H));
...
void BattlefieldWG::OnBattleStart() {
  // Spawn titan relic
  if (GameObject *relic =
          SpawnGameObject(GO_WINTERGRASP_TITAN_S_RELIC, WintergraspRelicPos,
                          WintergraspRelicRot)) {
  ...
  for (uint8 team = 0; team < BG_TEAMS_COUNT; ++team) {
    for (auto itr = m_players[team].begin(); itr != m_players[team].end();
         ++itr) {
...
void BattlefieldWG::OnBattleEnd(bool endByTimer) {
  ...
  // successful defense
  if (endByTimer)
    UpdateData(GetDefenderTeam() == TEAM_HORDE ? BATTLEFIELD_WG_DATA_DEF_H
                                               : BATTLEFIELD_WG_DATA_DEF_A,
               1);
  // successful attack (note that teams have already been swapped, so defender
  // team is the one who won)
  else
    UpdateData(GetDefenderTeam() == TEAM_HORDE ? BATTLEFIELD_WG_DATA_WON_H
  ...
  // Update portals
  for (auto itr = DefenderPortalList[GetDefenderTeam()].begin();
       itr != DefenderPortalList[GetDefenderTeam()].end(); ++itr)
    if (GameObject *portal = GetGameObject(*itr))
      portal->SetRespawnTime(RESPAWN_IMMEDIATELY);

  for (auto itr = DefenderPortalList[GetAttackerTeam()].begin();
       itr != DefenderPortalList[GetAttackerTeam()].end(); ++itr)
    if (GameObject *portal = GetGameObject(*itr))
  ...
  for (auto itr = m_PlayersInWar[GetDefenderTeam()].begin();
  ...
  for (auto itr = m_PlayersInWar[GetAttackerTeam()].begin();
       itr != m_PlayersInWar[GetAttackerTeam()].end(); ++itr)
    if (Player *player = ObjectAccessor::FindPlayer(*itr))
      player->CastSpell(player, SPELL_DEFEAT_REWARD, true);

  for (uint8 team = 0; team < BG_TEAMS_COUNT; ++team) {
    for (auto itr = m_PlayersInWar[team].begin();
    ...
    for (auto itr = m_vehicles[team].begin(); itr != m_vehicles[team].end();
         ++itr)
      if (Creature *creature = GetCreature(*itr))
...
// ******************* Reward System *********************
// *******************************************************
void BattlefieldWG::DoCompleteOrIncrementAchievement(
    uint32 achievement, Player *player, uint8 /*incrementNumber*/) {
  AchievementEntry const *achievementEntry =
      sAchievementMgr->GetAchievement(achievement);
...
void BattlefieldWG::HandlePromotion(Player *playerKiller, Unit *unitKilled) {
  ...
  for (auto iter = m_PlayersInWar[teamId].begin();
       iter != m_PlayersInWar[teamId].end(); ++iter)
...
void BattlefieldWG::PromotePlayer(Player *killer) {
  ...
  if (Aura *auraRecruit = killer->GetAura(SPELL_RECRUIT)) {
    if (auraRecruit->GetStackAmount() >= 5) {
      ...
      if (Creature *stalker = GetCreature(StalkerGuid))
        sCreatureTextMgr->SendChat(
            stalker, BATTLEFIELD_WG_TEXT_RANK_CORPORAL, killer, CHAT_MSG_ADDON,
            LANG_ADDON, TEXT_RANGE_NORMAL, 0, TEAM_OTHER, false, killer);
    } else
    ...
    if (auraCorporal->GetStackAmount() >= 5) {
      ...
      if (Creature *stalker = GetCreature(StalkerGuid))
        sCreatureTextMgr->SendChat(
            stalker, BATTLEFIELD_WG_TEXT_RANK_FIRST_LIEUTENANT, killer,
            CHAT_MSG_ADDON, LANG_ADDON, TEXT_RANGE_NORMAL, 0, TEAM_OTHER, false,
            killer);
    } else
      killer->CastSpell(killer, SPELL_CORPORAL, true);
  }
...
void BattlefieldWG::OnPlayerLeaveWar(Player *player) {
  ...
  if (!player->GetSession()->PlayerLogout()) {
    if (Creature *vehicle =
            player->GetVehicleCreatureBase()) // Remove vehicle of player if he
                                              // go out.
...
void BattlefieldWG::FillInitialWorldStates(
    WorldPackets::WorldState::InitWorldStates &data) {
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_A),
                                uint32(GetData(BATTLEFIELD_WG_DATA_DEF_A)));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_DEFENDED_H),
                                uint32(GetData(BATTLEFIELD_WG_DATA_DEF_H)));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_A),
                                uint32(GetData(BATTLEFIELD_WG_DATA_WON_A)));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_ATTACKED_H),
                                uint32(GetData(BATTLEFIELD_WG_DATA_WON_H)));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_ATTACKER),
                                uint32(GetAttackerTeam()));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_DEFENDER),
                                uint32(GetDefenderTeam()));
  data.Worldstates.emplace_back(
      uint32(BATTLEFIELD_WG_WORLD_STATE_ACTIVE),
      uint32(IsWarTime()
                 ? 0
                 : 1)); // Note: cleanup these two, their names look awkward
  data.Worldstates.emplace_back(
      uint32(BATTLEFIELD_WG_WORLD_STATE_SHOW_WORLDSTATE),
      uint32(IsWarTime() ? 1 : 0));

  for (uint32 i = 0; i < 2; ++i)
    data.Worldstates.emplace_back(
        ClockWorldState[i], uint32(GameTime::GetGameTime() + (m_Timer / 1000)));

  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_VEHICLE_H),
                                uint32(GetData(BATTLEFIELD_WG_DATA_VEHICLE_H)));
  data.Worldstates.emplace_back(
      uint32(BATTLEFIELD_WG_WORLD_STATE_MAX_VEHICLE_H),
      uint32(GetData(BATTLEFIELD_WG_DATA_MAX_VEHICLE_H)));
  data.Worldstates.emplace_back(uint32(BATTLEFIELD_WG_WORLD_STATE_VEHICLE_A),
                                uint32(GetData(BATTLEFIELD_WG_DATA_VEHICLE_A)));
  data.Worldstates.emplace_back(
      uint32(BATTLEFIELD_WG_WORLD_STATE_MAX_VEHICLE_A),
...
void BattlefieldWG::SendInitWorldStatesTo(Player *player) {
  WorldPacket data(SMSG_INIT_WORLD_STATES,
                   4 + 4 + 4 + 2 + (14 + WG_MAX_OBJ + WG_MAX_WORKSHOP) * 8);
  ...
  data << uint16(14 + BuildingsInZone.size() +
                 Workshops.size()); // Number of fields
...
void BattlefieldWG::UpdateVehicleCountWG() {
  SendUpdateWorldState(BATTLEFIELD_WG_WORLD_STATE_VEHICLE_H,
                       GetData(BATTLEFIELD_WG_DATA_VEHICLE_H));
  SendUpdateWorldState(BATTLEFIELD_WG_WORLD_STATE_MAX_VEHICLE_H,
                       GetData(BATTLEFIELD_WG_DATA_MAX_VEHICLE_H));
  SendUpdateWorldState(BATTLEFIELD_WG_WORLD_STATE_VEHICLE_A,
                       GetData(BATTLEFIELD_WG_DATA_VEHICLE_A));
  SendUpdateWorldState(BATTLEFIELD_WG_WORLD_STATE_MAX_VEHICLE_A,
                       GetData(BATTLEFIELD_WG_DATA_MAX_VEHICLE_A));
}
...
void BattlefieldWG::UpdateTenacity() {
  ...
  if (alliancePlayers && hordePlayers) {
    if (alliancePlayers < hordePlayers)
      newStack = int32((float(hordePlayers / alliancePlayers) - 1) *
                       4); // positive, should cast on alliance
    else if (alliancePlayers > hordePlayers)
      newStack = int32((1 - float(alliancePlayers / hordePlayers)) *
                       4); // negative, should cast on horde
  }
  ...
  if (m_tenacityTeam != TEAM_NEUTRAL) {
    for (auto itr = m_players[m_tenacityTeam].begin();
         itr != m_players[m_tenacityTeam].end(); ++itr)
      if (Player *player = ObjectAccessor::FindPlayer(*itr))
        if (player->getLevel() >= m_MinLevel)
          player->RemoveAurasDueToSpell(SPELL_TENACITY);

    for (auto itr = m_vehicles[m_tenacityTeam].begin();
         itr != m_vehicles[m_tenacityTeam].end(); ++itr)
      if (Creature *creature = GetCreature(*itr))
  ...
  if (newStack) {
    ...
    for (auto itr = m_PlayersInWar[m_tenacityTeam].begin();
         itr != m_PlayersInWar[m_tenacityTeam].end(); ++itr)
      if (Player *player = ObjectAccessor::FindPlayer(*itr))
...
BfWGGameObjectBuilding::BfWGGameObjectBuilding(
    BattlefieldWG *wg, WintergraspGameObjectBuildingType type,
    uint32 worldState) {
  ASSERT(wg);
...
void BfWGGameObjectBuilding::Rebuild() {
  ...
  case BATTLEFIELD_WG_OBJECTTYPE_WALL:
    _teamControl = _wg->GetDefenderTeam(); // Objects that are part of the keep
                                           // should be the defender's
    break;
  case BATTLEFIELD_WG_OBJECTTYPE_TOWER:
    _teamControl = _wg->GetAttackerTeam(); // The towers in the south should be
                                           // the attacker's
    break;
  default:
    _teamControl = TEAM_NEUTRAL;
  ...
  if (GameObject *build = _wg->GetGameObject(_buildGUID)) {
    ...
    if (build->IsDestructibleBuilding()) {
      ...
      if (build->GetEntry() == GO_WINTERGRASP_VAULT_GATE)
        if (GameObject *go = build->FindNearestGameObject(
                GO_WINTERGRASP_KEEP_COLLISION_WALL, 50.0f))
          go->SetGoState(GO_STATE_READY);

      // Update worldstate
      _state = WintergraspGameObjectState(
          BATTLEFIELD_WG_OBJECTSTATE_ALLIANCE_INTACT - (_teamControl * 3));
...
void BfWGGameObjectBuilding::Damaged() {
  // Update worldstate
  _state = WintergraspGameObjectState(
      BATTLEFIELD_WG_OBJECTSTATE_ALLIANCE_DAMAGE - (_teamControl * 3));
  _wg->SendUpdateWorldState(_worldState, _state);
...
void BfWGGameObjectBuilding::Destroyed() {
  // Update worldstate
  _state = WintergraspGameObjectState(
      BATTLEFIELD_WG_OBJECTSTATE_ALLIANCE_DESTROY - (_teamControl * 3));
  _wg->SendUpdateWorldState(_worldState, _state);
  ...
  case BATTLEFIELD_WG_OBJECTTYPE_DOOR_LAST:
    ...
    if (_wg->GetRelic())
      _wg->GetRelic()->RemoveFlag(GAMEOBJECT_FLAGS,
...
void BfWGGameObjectBuilding::Init(GameObject *go) {
  ...
  if (towerId >= BATTLEFIELD_WG_TOWER_SHADOWSIGHT) // Attacker towers
  {
    ...
    for (WintergraspGameObjectData const &gobData :
         AttackTowers[towerId - 4].GameObject) {
      if (GameObject *goHorde = _wg->SpawnGameObject(gobData.HordeEntry,
                                                     gobData.Pos, gobData.Rot))
        m_GameObjectList[TEAM_HORDE].push_back(goHorde->GetGUID());

      if (GameObject *goAlliance = _wg->SpawnGameObject(
              gobData.AllianceEntry, gobData.Pos, gobData.Rot))
        m_GameObjectList[TEAM_ALLIANCE].push_back(goAlliance->GetGUID());
    }

    // Spawn associate npc bottom
    for (WintergraspObjectPositionData const &creatureData :
         AttackTowers[towerId - 4].CreatureBottom) {
      if (Creature *creature =
              _wg->SpawnCreature(creatureData.HordeEntry, creatureData.Pos))
        m_CreatureBottomList[TEAM_HORDE].push_back(creature->GetGUID());

      if (Creature *creature =
              _wg->SpawnCreature(creatureData.AllianceEntry, creatureData.Pos))
  ...
  if (towerId >= 0) {
    ...
    for (Position const &turretPos : TowerCannon[towerId].TowerCannonBottom) {
      if (Creature *turret =
              _wg->SpawnCreature(NPC_WINTERGRASP_TOWER_CANNON, turretPos)) {
    ...
    for (Position const &towerCannonPos : TowerCannon[towerId].TurretTop) {
      if (Creature *turret = _wg->SpawnCreature(NPC_WINTERGRASP_TOWER_CANNON,
                                                towerCannonPos)) {
...
void BfWGGameObjectBuilding::FillInitialWorldStates(
    WorldPackets::WorldState::InitWorldStates &data) {
...
uint8 WintergraspWorkshop::GetId() const { return _staticInfo->WorkshopId; }
...
void WintergraspWorkshop::GiveControlTo(TeamId teamId, bool init /*= false*/) {
  ...
  case TEAM_NEUTRAL: {
    ...
    _wg->SendWarning(_teamControl == TEAM_ALLIANCE
                         ? _staticInfo->TextIds.HordeAttack
                         : _staticInfo->TextIds.AllianceAttack);
    break;
  }
  case TEAM_ALLIANCE: {
    // Updating worldstate
    ...
    if (!init)
      _wg->SendWarning(
          _staticInfo->TextIds.AllianceCapture); // workshop taken - alliance
  ...
  case TEAM_HORDE: {
    ...
    if (!init)
      _wg->SendWarning(
          _staticInfo->TextIds.HordeCapture); // workshop taken - horde
...
void WintergraspWorkshop::FillInitialWorldStates(
    WorldPackets::WorldState::InitWorldStates &data) {
  data.Worldstates.emplace_back(uint32(_staticInfo->WorldStateId),
                                uint32(_state));
}
