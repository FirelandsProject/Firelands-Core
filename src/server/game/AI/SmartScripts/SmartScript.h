...
class SmartScript
{
    public:
        ...
        Creature* FindCreatureNear(WorldObject* searchObject, uint32 guid) const
        {
            ...
            Firelands::CreatureWithDbGUIDCheck target_check(searchObject, guid);
            Firelands::CreatureSearcher<Firelands::CreatureWithDbGUIDCheck> checker(searchObject, creature, target_check);
