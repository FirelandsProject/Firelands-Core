...
{
    _recordUpdateTimeInverval = sConfigMgr->GetOption<int32>("RecordUpdateTimeDiffInterval", 60000);
    _recordUpdateTimeMin = sConfigMgr->GetOption<int32>("MinRecordUpdateTimeDiff", 100);
}
