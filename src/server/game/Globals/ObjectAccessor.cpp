...
{
    FIRELANDS_READ_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        FIRELANDS_WRITE_GUARD(ACE_RW_Thread_Mutex, i_corpseLock);
        ...
        CellCoord cellCoord = Firelands::ComputeCellCoord(corpse->GetPositionX(), corpse->GetPositionY());
...
Corpse* ObjectAccessor::ConvertCorpseForPlayer(uint64 player_guid, bool insignia /*=false*/)
{
    ...
    LOG_DEBUG("misc", "Deleting Corpse and spawned bones.");
