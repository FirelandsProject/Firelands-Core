...
namespace Firelands::Impl::EnumUtilsImpl
{
    ...
    FC_API_EXPORT EnumText EnumUtils<CreatureFlagsExtra>::ToString(CreatureFlagsExtra value)
    {
        ...
        case CREATURE_FLAG_EXTRA_NO_COMBAT: return { "CREATURE_FLAG_EXTRA_NO_COMBAT", "CREATURE_FLAG_EXTRA_NO_COMBAT", "creature ignore combat." };
        ...
        case CREATURE_FLAG_EXTRA_AVOID_AOE: return { "CREATURE_FLAG_EXTRA_AVOID_AOE", "CREATURE_FLAG_EXTRA_AVOID_AOE", "ignored by aoe attacks (for icc blood prince council npc - Dark Nucleus)" };
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<CreatureFlagsExtra>::Count() { return 32; }

    template <>
    FC_API_EXPORT CreatureFlagsExtra EnumUtils<CreatureFlagsExtra>::FromIndex(size_t index)
    {
        switch (index)
        {
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<CreatureFlagsExtra>::ToIndex(CreatureFlagsExtra value)
    {
        switch (value)
        {
