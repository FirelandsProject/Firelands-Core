...
enum CreatureFlagsExtra : uint32
{
    ...
    CREATURE_FLAG_EXTRA_IGNORE_FEIGN_DEATH = 0x00010000, // Creature ignore feign death
    ...
    // Masks
    CREATURE_FLAG_EXTRA_UNUSED = (CREATURE_FLAG_EXTRA_UNUSED_26 | CREATURE_FLAG_EXTRA_UNUSED_27 | CREATURE_FLAG_EXTRA_UNUSED_28),
