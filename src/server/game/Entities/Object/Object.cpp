...
void MovementInfo::OutDebug()
{
    ...
    if (t_guid)
    {
        ...
        if (flags2 & MOVEMENTFLAG2_INTERPOLATED_MOVEMENT)
            LOG_INFO("misc", "time2: %u", t_time2);
    }

    if ((flags & (MOVEMENTFLAG_SWIMMING | MOVEMENTFLAG_FLYING)) || (flags2 & MOVEMENTFLAG2_ALWAYS_ALLOW_PITCHING))
        LOG_INFO("misc", "pitch: %f", pitch);

    LOG_INFO("misc", "fallTime: %u", fallTime);
    if (flags & MOVEMENTFLAG_FALLING)
        LOG_INFO("misc", "j_zspeed: %f j_sinAngle: %f j_cosAngle: %f j_xyspeed: %f", j_zspeed, j_sinAngle, j_cosAngle, j_xyspeed);

    if (flags & MOVEMENTFLAG_SPLINE_ELEVATION)
        LOG_INFO("misc", "splineElevation: %f", splineElevation);
}
...
void WorldObject::MonsterSay(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    Firelands::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, text, language, TargetGuid);
    Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> say_do(say_build);
    Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterSay(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Firelands::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_SAY, textId, language, TargetGuid);
    Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> say_do(say_build);
    Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
    TypeContainerVisitor<Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY));
}
...
void WorldObject::MonsterYell(const char* text, uint32 language, uint64 TargetGuid)
{
    ...
    Firelands::MonsterCustomChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, text, language, TargetGuid);
    Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> say_do(say_build);
    Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterCustomChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterYell(int32 textId, uint32 language, uint64 TargetGuid)
{
    ...
    Firelands::MonsterChatBuilder say_build(*this, CHAT_MSG_MONSTER_YELL, textId, language, TargetGuid);
    Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> say_do(say_build);
    Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL), say_do);
    TypeContainerVisitor<Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
    cell.Visit(p, message, *GetMap(), *this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_YELL));
}
...
void WorldObject::MonsterTextEmote(int32 textId, uint64 TargetGuid, bool IsBossEmote)
{
    ...
    Firelands::MonsterChatBuilder say_build(*this, IsBossEmote ? CHAT_MSG_RAID_BOSS_EMOTE : CHAT_MSG_MONSTER_EMOTE, textId, LANG_UNIVERSAL, TargetGuid);
    Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> say_do(say_build);
    Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> > say_worker(this, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_TEXTEMOTE), say_do);
    TypeContainerVisitor<Firelands::PlayerDistWorker<Firelands::LocalizedPacketDo<Firelands::MonsterChatBuilder> >, WorldTypeMapContainer > message(say_worker);
...
void WorldObject::MonsterWhisper(int32 textId, uint64 receiver, bool IsBossWhisper)
{
    ...
    LocaleConstant loc_idx = player->GetSession()->GetSessionDbLocaleIndex();
    char const* text = sObjectMgr->GetFirelandsString(textId, loc_idx);
...
void WorldObject::AddObjectToRemoveList()
{
    ...
    if (!map)
    {
        LOG_ERROR("misc", "Object (TypeId: %u Entry: %u GUID: %u) at attempt add to move list not have valid map (Id: %u).", GetTypeId(), GetEntry(), GetGUIDLow(), GetMapId());
        return;
    }
...
{
    //LOG_INFO("network.opcode", "Map::SummonCreature() Summoner: %s [GUID: %u] entry: %u  Map: %u Position x: %f  y: %f  z: %f", summoner ? summoner->GetName().c_str() : "No summoner", summoner ? summoner->GetGUIDLow() : 0, entry, GetId(), pos.GetPositionX(), pos.GetPositionY(), pos.GetPositionZ());
...
Creature* WorldObject::FindNearestCreature(uint32 entry, float range, bool alive) const
{
    ...
    Firelands::NearestCreatureDistinctEntryWithLiveStateInObjectRangeCheck checker(*this, entry, alive, range);
    Firelands::CreatureLastSearcher<Firelands::NearestCreatureDistinctEntryWithLiveStateInObjectRangeCheck> searcher(this, creature, checker);
...
Player* WorldObject::FindNearestPlayer(float range) const
{
    ...
    Firelands::NearestPlayerInObjectRangeCheck checker(this, range);
...
std::list<Player*> WorldObject::GetPlayersInRange(float range, bool alive, bool withGamemaster) const
{
    ...
    Firelands::AnyPlayerInObjectRangeCheck checker(this, range, alive, withGamemaster);
    Firelands::PlayerListSearcher<Firelands::AnyPlayerInObjectRangeCheck> searcher(this, players, checker);
...
{
    CellCoord pair(Firelands::ComputeCellCoord(this->GetPositionX(), this->GetPositionY()));
    Cell cell(pair);
    cell.SetNoCreate();

    Firelands::AllGameObjectsWithEntryInRange check(this, entry, maxSearchRange);
    Firelands::GameObjectListSearcher<Firelands::AllGameObjectsWithEntryInRange> searcher(this, gameobjectList, check);
    TypeContainerVisitor<Firelands::GameObjectListSearcher<Firelands::AllGameObjectsWithEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetCreatureListWithEntryInGrid(std::list<Creature*>& creatureList, uint32 entry, float maxSearchRange) const
{
    ...
    Firelands::CreatureListSearcher<Firelands::AllCreaturesOfEntryInRange> searcher(this, creatureList, check);
    TypeContainerVisitor<Firelands::CreatureListSearcher<Firelands::AllCreaturesOfEntryInRange>, GridTypeMapContainer> visitor(searcher);
...
void WorldObject::GetNearPoint(WorldObject const* /*searcher*/, float &x, float &y, float &z, float searcher_size, float distance2d, float absAngle) const
{
    ...
    // adding used positions around object
    {
        ...
        Firelands::NearUsedPosDo u_do(*this, searcher, absAngle, selector);
        Firelands::WorldObjectWorker<Firelands::NearUsedPosDo> worker(this, u_do);

        TypeContainerVisitor<Firelands::WorldObjectWorker<Firelands::NearUsedPosDo>, GridTypeMapContainer  > grid_obj_worker(worker);
        TypeContainerVisitor<Firelands::WorldObjectWorker<Firelands::NearUsedPosDo>, WorldTypeMapContainer > world_obj_worker(worker);
...
void WorldObject::MovePosition(Position &pos, float dist, float angle, bool limitZValue)
{
    ...
    if (!Firelands::IsValidMapCoord(pos.m_positionX, pos.m_positionY, pos.m_positionZ))
    {
        LOG_FATAL("misc", "WorldObject::MovePosition invalid coordinates X: %f and Y: %f were passed!", pos.m_positionX, pos.m_positionY);
        return;
    }
...
void WorldObject::MoveBlink(Position &pos, float dist, float angle)
{
    ...
    if (!Firelands::IsValidMapCoord(destx, desty)) // Prevent invalid coordinates here, position is unchanged
    {
        LOG_FATAL("misc", "WorldObject::MoveBlink invalid coordinates X: %f and Y: %f were passed!", destx, desty);
        return;
    }
...
void WorldObject::DestroyForNearbyPlayers()
{
    ...
    Firelands::AnyPlayerInObjectRangeCheck check(this, GetVisibilityRange(), false, true);
