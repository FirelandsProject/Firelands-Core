    ...
    do
    {
        ...
        switch (type)
        {
            ...
            case DISABLE_TYPE_MMAP:
            {
                ...
                switch (mapEntry->map_type)
                {
                    ...
                    case MAP_RAID:
                        ...
                        break;
                    case MAP_BATTLEGROUND:
                        LOG_INFO("misc", "Pathfinding disabled for battleground map {}.", entry);
                        break;
                    case MAP_ARENA:
            ...
            case DISABLE_TYPE_HEIGHT_RELOCATION:
            {
                ...
                {
                    case MAP_COMMON:
                        LOG_INFO("misc", "Height relocation disabled for world map {}.", entry);
                        break;
                    case MAP_INSTANCE:
                    case MAP_RAID:
                        LOG_INFO("misc", "Height relocation disabled for instance map {}.", entry);
                        break;
                    case MAP_BATTLEGROUND:
                        LOG_INFO("misc", "Height relocation disabled for battleground map {}.", entry);
                        break;
                    case MAP_ARENA:
                        LOG_INFO("misc", "Height relocation disabled for arena map {}.", entry);
                        break;
                    default:
                        break;
                }
