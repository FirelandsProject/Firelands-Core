...
namespace Firelands::Impl::ChatCommands
{
    ...
    private:
        ...
        std::variant<std::monostate, FirelandsStrings, std::string> _help;
...
namespace Firelands::ChatCommands
{
    struct ChatCommandBuilder
    {
        ...
        {
            template <typename T>
            InvokerEntry(T& handler, FirelandsStrings help, uint32 securityLevel, Firelands::ChatCommands::Console allowConsole)
        ...
        template <typename TypedHandler>
        ChatCommandBuilder(char const* name, TypedHandler& handler, FirelandsStrings help, uint32 securityLevel, Firelands::ChatCommands::Console allowConsole)
        ...
        ChatCommandBuilder(char const* name, TypedHandler& handler, uint32 securityLevel, Firelands::ChatCommands::Console allowConsole)
            : ChatCommandBuilder(name, handler, FirelandsStrings(), securityLevel, allowConsole) { }
        ...
        ChatCommandBuilder(char const* name, bool(&handler)(ChatHandler*, char const*), uint32 securityLevel, Firelands::ChatCommands::Console allowConsole)
            : ChatCommandBuilder(name, handler, FirelandsStrings(), securityLevel, allowConsole) { }
        ...
        ChatCommandBuilder(char const* name, uint32 securityLevel, bool console, TypedHandler* handler, char const*)
            : ChatCommandBuilder(name, *handler, FirelandsStrings(), securityLevel, static_cast<Firelands::ChatCommands::Console>(console)) { }
