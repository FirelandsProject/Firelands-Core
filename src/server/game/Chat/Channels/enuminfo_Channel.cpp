...
namespace Firelands::Impl::EnumUtilsImpl
{
    ...
    \************************************************************/
    template <>
    FC_API_EXPORT EnumText EnumUtils<ChatNotify>::ToString(ChatNotify value)
    {
        switch (value)
        {
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<ChatNotify>::Count() { return 36; }

    template <>
    FC_API_EXPORT ChatNotify EnumUtils<ChatNotify>::FromIndex(size_t index)
    {
        switch (index)
        {
    ...
    template <>
    FC_API_EXPORT size_t EnumUtils<ChatNotify>::ToIndex(ChatNotify value)
    {
        switch (value)
        {
