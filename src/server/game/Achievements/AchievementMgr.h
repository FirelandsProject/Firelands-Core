...
struct AchievementCriteriaData
{
    ...
    union
    {
        ...
        // ACHIEVEMENT_CRITERIA_DATA_TYPE_NTH_BIRTHDAY      = 25
        struct
        {
            uint32 nth_birthday;
        } birthday_login;
...
public:
    ...
    [[nodiscard]] AchievementCriteriaEntryList const& GetAchievementCriteriaByType(AchievementCriteriaTypes type, bool guild = false) const
    {
