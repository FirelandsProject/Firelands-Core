...
bool AchievementCriteriaData::IsValid(
  ...
  if (dataType >= MAX_ACHIEVEMENT_CRITERIA_DATA_TYPE) {
    LOG_ERROR("sql.sql",
              ...
              "contains a wrong data type ({}), ignored.",
  ...
  default:
    if (dataType != ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` contains data for a "
                "non-supported criteria type (Entry: {} Type: {}), ignored.",
                criteria->ID, criteria->Type);
      return false;
    }
    break;
  }
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_CREATURE:
    if (!creature.id || !sObjectMgr->GetCreatureTemplate(creature.id)) {
      LOG_ERROR("sql.sql",
                ...
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_CREATURE ({}) "
                "contains a non-existing creature id in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE:
    ...
    if (classRace.class_id &&
      ...
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE "
                "({}) contains a non-existing class in value1 ({}), ignored.",
    ...
    if (classRace.race_id &&
      ...
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_CLASS_RACE "
                "({}) contains a non-existing race in value2 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_PLAYER_LESS_HEALTH:
    if (health.percent < 1 || health.percent > 100) {
      LOG_ERROR("sql.sql",
                ...
                "({}) contains a wrong percent value in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_AURA: {
    ...
    if (!spellEntry) {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data "
          "type {} ({}) contains a wrong spell id in value1 ({}), ignored.",
          criteria->ID, criteria->Type,
    ...
    if (aura.effect_idx >= 3) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type {} ({}) contains a wrong spell effect index in "
                "value2 ({}), ignored.",
                criteria->ID, criteria->Type,
                (dataType == ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA
                     ? "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA"
    ...
    if (!spellEntry->Effects[aura.effect_idx].ApplyAuraName) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type {} ({}) contains a non-aura spell effect (ID: {} "
                "Effect: {}), ignored.",
                criteria->ID, criteria->Type,
                (dataType == ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA
                     ? "ACHIEVEMENT_CRITERIA_DATA_TYPE_S_AURA"
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE:
    if (value.compType >= COMP_TYPE_MAX) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_VALUE ({}) contains "
                "a wrong ComparisionType in value2 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL:
    if (level.minlevel > STRONG_MAX_LEVEL) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_LEVEL ({}) "
                "contains a wrong minlevel in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER:
    if (gender.gender > GENDER_NONE) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_GENDER ({}) "
                "contains a wrong gender value in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT:
    if (!ScriptId) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT ({}) does not "
                "have a ScriptName set, ignored.",
                criteria->ID, criteria->Type, dataType);
      return false;
    }
    return true;
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT:
    if (map_players.maxcount <= 0) {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data "
          "type ACHIEVEMENT_CRITERIA_DATA_TYPE_MAP_PLAYER_COUNT ({}) contains "
          "a wrong max players count in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM:
    if (team.team != ALLIANCE && team.team != HORDE) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_T_TEAM ({}) contains "
                "an unknown team value in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK:
    if (drunk.state >= MAX_DRUNKEN) {
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data "
          "type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_DRUNK ({}) contains an "
          "unknown drunken state value in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY:
    if (!sHolidaysStore.LookupEntry(holiday.id)) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_HOLIDAY ({}) "
                "contains an unknown holiday entry in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_GAME_EVENT: {
    ...
    if (game_event.id < 1 || game_event.id >= events.size()) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_GAME_EVENT ({}) has "
                "unknown game_event in value1 ({}), ignored.",
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_ITEM_QUALITY:
    if (equipped_item.item_quality >= MAX_ITEM_QUALITY) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type {} ({}) contains an unknown quality state value in "
                "value1 ({}), ignored.",
                criteria->ID, criteria->Type,
                (dataType == ACHIEVEMENT_CRITERIA_DATA_TYPE_S_EQUIPPED_ITEM
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE:
    if (!classRace.class_id && !classRace.race_id) {
      LOG_ERROR("sql.sql",
                ...
                "({}) should not have 0 in either value field. Ignored.",
                criteria->ID, criteria->Type, dataType);
      return false;
    }
    if (classRace.class_id &&
      ...
      LOG_ERROR(
          "sql.sql",
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data "
          "type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) "
          "contains a non-existing class entry in value1 ({}), ignored.",
          criteria->ID, criteria->Type, dataType, classRace.class_id);
      return false;
    }
    if (classRace.race_id &&
      ...
      LOG_ERROR(
          ...
          "Table `achievement_criteria_data` (Entry: {} Type: {}) for data "
          "type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_PLAYER_CLASS_RACE ({}) "
          "contains a non-existing race entry in value2 ({}), ignored.",
          criteria->ID, criteria->Type, dataType, classRace.race_id);
      return false;
    }
    return true;
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_KNOWN_TITLE:
    if (!sCharTitlesStore.LookupEntry(known_title.title_id)) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` (Entry: {} Type: {}) for "
                "data type ACHIEVEMENT_CRITERIA_DATA_TYPE_S_KNOWN_TITLE ({}) "
                "contains an unknown title_id in value1 ({}), ignore.",
  ...
  default:
    LOG_ERROR("sql.sql",
              "Table `achievement_criteria_data` (Entry: {} Type: {}) contains "
              "data of a non-supported data type ({}), ignored.",
              criteria->ID, criteria->Type, dataType);
    return false;
  }
}
...
bool AchievementCriteriaData::Meets(uint32 criteria_id, Player const *source,
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT: {
    ...
    if (!map->IsDungeon()) {
      LOG_ERROR("achievement",
                ...
                "achievement criteria {} in a non-dungeon/non-raid map {}",
    ...
    if (!instance) {
      LOG_ERROR("achievement",
                "Achievement system call "
                "ACHIEVEMENT_CRITERIA_DATA_TYPE_INSTANCE_SCRIPT ({}) for "
                "achievement criteria {} in map {}, but the map does not have "
                "an instance script.",
                dataType, criteria_id, map->GetId());
      return false;
    }
  ...
  case ACHIEVEMENT_CRITERIA_DATA_TYPE_S_EQUIPPED_ITEM: {
    AchievementCriteriaEntry const *entry =
        ASSERT_NOTNULL(sAchievementMgr->GetAchievementCriteria(criteria_id));

    uint32 itemId =
        (entry->Type == ACHIEVEMENT_CRITERIA_TYPE_EQUIP_EPIC_ITEM ? miscValue2
                                                                  : miscValue1);
    ItemTemplate const *itemTemplate = sObjectMgr->GetItemTemplate(itemId);
    if (!itemTemplate)
      return false;

    return itemTemplate->GetBaseItemLevel() >= equipped_item.item_level &&
           itemTemplate->GetQuality() >= equipped_item.item_quality;
  }
...
AchievementMgr<T>::AchievementMgr(T *owner)
    : _owner(owner), _achievementPoints(0) {}

template <class T> AchievementMgr<T>::~AchievementMgr() {}
...
template <class T>
void AchievementMgr<T>::RemoveCriteriaProgress(
    AchievementCriteriaEntry const *entry) {
  if (!entry)
    return;
...
template <>
void AchievementMgr<Guild>::RemoveCriteriaProgress(
    AchievementCriteriaEntry const *entry) {
  if (!entry)
    return;
...
template <class T>
void AchievementMgr<T>::ResetAchievementCriteria(
    AchievementCriteriaCondition condition, uint64 value,
    bool evenIfCriteriaComplete) {
  LOG_DEBUG("achievement", "ResetAchievementCriteria({}, " UI64FMTD ", {})",
  ...
  for (auto itr = achievementCriteriaList->begin();
       itr != achievementCriteriaList->end(); ++itr) {
    AchievementCriteriaEntry const *achievementCriteria = *itr;
    AchievementEntry const *achievement = sAchievementMgr->GetAchievement(
...
template <>
void AchievementMgr<Guild>::ResetAchievementCriteria(
    AchievementCriteriaCondition /*condition*/, uint64 /*value*/,
    bool /*evenIfCriteriaComplete*/) {
  // Not needed
}

template <class T> void AchievementMgr<T>::DeleteFromDB(ObjectGuid /*guid*/) {}

template <> void AchievementMgr<Player>::DeleteFromDB(ObjectGuid guid) {
...
template <> void AchievementMgr<Guild>::DeleteFromDB(ObjectGuid guid) {
  CharacterDatabaseTransaction trans = CharacterDatabase.BeginTransaction();

  CharacterDatabasePreparedStatement *stmt =
      CharacterDatabase.GetPreparedStatement(CHAR_DEL_ALL_GUILD_ACHIEVEMENTS);
  stmt->SetData(0, guid.GetCounter());
  trans->Append(stmt);
...
void AchievementMgr<Guild>::SaveToDB(CharacterDatabaseTransaction &trans) {
  ...
  for (CompletedAchievementMap::const_iterator itr =
           m_completedAchievements.begin();
    ...
    stmt->SetData(0, GetOwner()->GetId());
    stmt->SetData(1, itr->first);
    stmt->SetData(2, uint32(itr->second.date));
    for (GuidSet::const_iterator gItr = itr->second.guids.begin();
         gItr != itr->second.guids.end(); ++gItr)
  ...
  for (CriteriaProgressMap::const_iterator itr = m_criteriaProgress.begin();
       itr != m_criteriaProgress.end(); ++itr) {
    if (!itr->second.changed)
      continue;
    ...
    stmt->SetData(3, uint32(itr->second.date));
...
void AchievementMgr<Player>::LoadFromDB(PreparedQueryResult achievementResult,
  ...
  if (achievementResult) {
    do {
      ...
      AchievementEntry const *achievement =
          sAchievementMgr->GetAchievement(achievementid);
      if (!achievement)
        continue;
      ...
      if (AchievementReward const *reward =
        ...
        if (uint32 titleId =
                reward->TitleID[Player::TeamForRace(GetOwner()->getRace()) ==
                                        ALLIANCE
                                    ? 0
                                    : 1])
  ...
  if (criteriaResult) {
    do {
      ...
      AchievementCriteriaEntry const *criteria =
          sAchievementMgr->GetAchievementCriteria(id);
      if (!criteria) {
        // Removing non-existing criteria data for all characters
        LOG_ERROR("achievement",
                  "Non-existing achievement criteria {} data has been removed "
                  "from the table `character_achievement_progress`.",
                  id);
      ...
      if (criteria->StartTimer &&
          time_t(date + criteria->StartTimer) < GameTime::GetGameTime())
        continue;
...
template <>
void AchievementMgr<Guild>::LoadFromDB(PreparedQueryResult achievementResult,
                                       PreparedQueryResult criteriaResult) {
  if (achievementResult) {
    do {
      Field *fields = achievementResult->Fetch();
      ...
      std::vector<std::string_view> guids =
          Firelands::Tokenize(fields[2].Get<std::string_view>(), ' ', true);
      for (uint32 i = 0; i < guids.size(); ++i) {
        ca.guids.insert(ObjectGuid(HighGuid::Player,
                                   *Firelands::StringTo<uint32>(guids[i])));
      }
  ...
  if (criteriaResult) {
    do {
      ...
      if (!criteria) {
        ...
        LOG_ERROR("achievement",
                  "Non-existing achievement criteria {} data removed from "
...
template <class T> void AchievementMgr<T>::Reset() {}

template <> void AchievementMgr<Player>::Reset() {
...
template <> void AchievementMgr<Guild>::Reset() {
  ObjectGuid guid = GetOwner()->GetGUID();
  for (CompletedAchievementMap::const_iterator iter =
           m_completedAchievements.begin();
       iter != m_completedAchievements.end(); ++iter) {
  ...
  while (!m_criteriaProgress.empty())
    if (AchievementCriteriaEntry const *criteria =
            sAchievementMgr->GetAchievementCriteria(
                m_criteriaProgress.begin()->first))
...
template <class T>
void AchievementMgr<T>::SendAchievementEarned(
    AchievementEntry const *achievement) const {
  // Don't send for achievements with ACHIEVEMENT_FLAG_HIDDEN
  if (achievement->Flags & ACHIEVEMENT_FLAG_HIDDEN)
    return;

  LOG_DEBUG("achievement", "AchievementMgr::SendAchievementEarned({})",
            achievement->ID);

  if (Guild *guild = sGuildMgr->GetGuildById(GetOwner()->GetGuildId())) {
    Firelands::BroadcastTextBuilder _builder(
        GetOwner(), CHAT_MSG_GUILD_ACHIEVEMENT,
        BROADCAST_TEXT_ACHIEVEMENT_EARNED, GetOwner()->getGender(), _owner,
        achievement->ID);
    Firelands::LocalizedPacketDo<Firelands::BroadcastTextBuilder> _localizer(
        _builder);
    guild->BroadcastWorker(_localizer, GetOwner());
  }

  if (achievement->Flags &
      (ACHIEVEMENT_FLAG_REALM_FIRST_KILL | ACHIEVEMENT_FLAG_REALM_FIRST_REACH |
       ACHIEVEMENT_FLAG_REALM_FIRST_GUILD)) {
    // broadcast realm first reached
    WorldPacket data(SMSG_SERVER_FIRST_ACHIEVEMENT,
                     GetOwner()->GetName().size() + 1 + 8 + 4 + 4);
    data << GetOwner()->GetName();
    data << uint64(GetOwner()->GetGUID());
    data << uint32(achievement->ID);
    data << uint32(
        0); // 1=link supplied string as player name, 0=display plain string
    sWorld->SendGlobalMessage(&data);
  }
  // if player is in world he can tell his friends about new achievement
  else if (GetOwner()->IsInWorld()) {
    Firelands::BroadcastTextBuilder _builder(
        GetOwner(), CHAT_MSG_ACHIEVEMENT, BROADCAST_TEXT_ACHIEVEMENT_EARNED,
        GetOwner()->getGender(), _owner, achievement->ID);
    Firelands::LocalizedPacketDo<Firelands::BroadcastTextBuilder> _localizer(
        _builder);
    Firelands::PlayerDistWorker<
        Firelands::LocalizedPacketDo<Firelands::BroadcastTextBuilder>>
        _worker(GetOwner(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY),
                _localizer);
    Cell::VisitWorldObjects(GetOwner(), _worker,
  ...
  GetOwner()->SendMessageToSetInRange(
      &data, sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), true);
}

template <>
void AchievementMgr<Guild>::SendAchievementEarned(
    AchievementEntry const *achievement) const {
  ObjectGuid guid = GetOwner()->GetGUID();
...
template <class T>
void AchievementMgr<T>::SendCriteriaUpdate(
    AchievementCriteriaEntry const * /*entry*/,
    CriteriaProgress const * /*progress*/, uint32 /*timeElapsed*/,
    bool /*timedCompleted*/) const {}

template <>
void AchievementMgr<Player>::SendCriteriaUpdate(
    AchievementCriteriaEntry const *entry, CriteriaProgress const *progress,
  ...
  if (entry->StartTimer)
    criteriaUpdate.Flags =
        timedCompleted ? 1 : 0; // 1 is for keeping the counter at 0 in client
...
template <>
void AchievementMgr<Guild>::SendCriteriaUpdate(
    AchievementCriteriaEntry const *entry, CriteriaProgress const *progress,
    uint32 /*timeElapsed*/, bool /*timedCompleted*/) const {
  ...
  ObjectGuid counter(
      progress->counter); // for accessing every byte individually
...
template <class T>
void AchievementMgr<T>::SendAllTrackedCriterias(
    Player * /*receiver*/,
    std::set<uint32> const & /*trackedCriterias*/) const {}

template <>
void AchievementMgr<Guild>::SendAllTrackedCriterias(
    Player *receiver, std::set<uint32> const &trackedCriterias) const {
  return;
  ...
  for (std::set<uint32>::iterator itr = trackedCriterias.begin();
       itr != trackedCriterias.end(); ++itr) {
    AchievementCriteriaEntry const *entry =
        sAchievementMgr->GetAchievementCriteria(*itr);

    CriteriaProgressMap::const_iterator progress =
        m_criteriaProgress.find(entry->ID);
  ...
  for (std::set<uint32>::iterator itr = trackedCriterias.begin();
    ...
    criteriaData << uint32(
        progress->second.date); // last update time (not packed!)
  ...
  WorldPacket data(SMSG_GUILD_CRITERIA_DATA,
                   criteriaBits.size() + criteriaData.size());
...
void AchievementMgr<T>::CheckAllAchievementCriteria(Player *referencePlayer) {
  ...
  for (uint32 i = 0; i < ACHIEVEMENT_CRITERIA_TYPE_TOTAL; ++i)
    UpdateAchievementCriteria(AchievementCriteriaTypes(i), 0, 0, 0, nullptr,
                              referencePlayer);
}
...
// Helper function to avoid having to specialize template for a 800 line long
// function
 ...
 */
template <class T>
void AchievementMgr<T>::UpdateAchievementCriteria(
    AchievementCriteriaTypes type, uint64 miscValue1 /*= 0*/,
    uint64 miscValue2 /*= 0*/, uint64 miscValue3 /*= 0*/,
    Unit const *unit /*= nullptr*/, Player *referencePlayer /*= nullptr*/,
  ...
  if (!referencePlayer) {
    LOG_DEBUG(
        "achievement",
        "UpdateAchievementCriteria: Player is nullptr! Cant update criteria");
    return;
  }
  ...
  if (referencePlayer->IsGameMaster()) {
    LOG_DEBUG("achievement",
              "UpdateAchievementCriteria: [Player {} GM mode on] {}, {} "
              "({}), " UI64FMTD ", " UI64FMTD ", " UI64FMTD,
              referencePlayer->GetName().c_str(),
              GetOwner()->GetGUID().ToString().c_str(),
              AchievementGlobalMgr::GetCriteriaTypeString(type), type,
              miscValue1, miscValue2, miscValue3);
    return;
  }

  LOG_DEBUG("achievement",
            "UpdateAchievementCriteria: {}, {} ({}), " UI64FMTD ", " UI64FMTD
            ", " UI64FMTD,
            GetOwner()->GetGUID().ToString().c_str(),
            AchievementGlobalMgr::GetCriteriaTypeString(type), type, miscValue1,
            miscValue2, miscValue3);

  // Lua_GetGuildLevelEnabled() is checked in achievement UI to display guild
  // tab
  if (IsGuild<T>() && !sWorld->getBoolConfig(CONFIG_GUILD_LEVELING_ENABLED))
    return;

  AchievementCriteriaEntryList const &achievementCriteriaList =
      sAchievementMgr->GetAchievementCriteriaByType(type, miscValue1,
                                                    IsGuild<T>());
  for (AchievementCriteriaEntryList::const_iterator i =
    ...
    if (!achievement) {
      LOG_ERROR("achievement",
                "UpdateAchievementCriteria: Achievement {} not found!",
                achievementCriteria->ReferredAchievement);
      continue;
    }

    if (!CanUpdateCriteria(achievementCriteria, achievement, miscValue1,
                           miscValue2, miscValue3, unit, referencePlayer, go))
      continue;
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_ARCHAEOLOGY_PROJECTS:
      SetCriteriaProgress(achievementCriteria, miscValue2, referencePlayer,
                          PROGRESS_ACCUMULATE);
      break;
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_HIGHEST_HEALING_RECEIVED:
      ...
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_REACH_LEVEL:
      SetCriteriaProgress(achievementCriteria, referencePlayer->getLevel(),
                          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_REACH_SKILL_LEVEL:
      if (uint32 skillvalue = referencePlayer->GetBaseSkillValue(
              achievementCriteria->Asset.SkillID))
        SetCriteriaProgress(achievementCriteria, skillvalue, referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_LEARN_SKILL_LEVEL:
      if (uint32 skillStep =
              referencePlayer->GetSkillStep(achievementCriteria->Asset.SkillID))
        SetCriteriaProgress(achievementCriteria, skillStep, referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUEST_COUNT:
      SetCriteriaProgress(achievementCriteria,
                          referencePlayer->GetRewardedQuestCount(),
                          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_DAILY_QUEST_DAILY: {
      ...
      if (!progress)
        ...
        // last progress is older than 2 days. Player missed 1 day => Restart
        // count.
        progressType = PROGRESS_SET;
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUESTS_IN_ZONE: {
      ...
      for (RewardedQuestSet::const_iterator itr = rewQuests.begin();
        ...
        if (quest && quest->GetZoneOrSort() >= 0 &&
            uint32(quest->GetZoneOrSort()) == achievementCriteria->Asset.ZoneID)
          ++counter;
      }
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_GAIN_EXALTED_REPUTATION:
      SetCriteriaProgress(
          achievementCriteria,
          referencePlayer->GetReputationMgr().GetExaltedFactionCount(),
          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_LEARN_SKILLLINE_SPELLS: {
      uint32 spellCount = 0;
      for (std::pair<uint32 const, PlayerSpell> const &spellIter :
           referencePlayer->GetSpellMap()) {
        ...
        for (SkillLineAbilityMap::const_iterator skillIter = bounds.first;
          ...
          if (skillIter->second->SkillLine ==
              achievementCriteria->Asset.SkillID) {
            // do not add couter twice if by any chance skill is listed twice in
            // dbc (eg. skill 777 and spell 22717)
            ++spellCount;
            break;
          }
        }
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_GAIN_REVERED_REPUTATION:
      SetCriteriaProgress(
          achievementCriteria,
          referencePlayer->GetReputationMgr().GetReveredFactionCount(),
          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_GAIN_HONORED_REPUTATION:
      SetCriteriaProgress(
          achievementCriteria,
          referencePlayer->GetReputationMgr().GetHonoredFactionCount(),
          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_KNOWN_FACTIONS:
      SetCriteriaProgress(
          achievementCriteria,
          referencePlayer->GetReputationMgr().GetVisibleFactionCount(),
          referencePlayer);
      break;
    ...
    case ACHIEVEMENT_CRITERIA_TYPE_EARN_HONORABLE_KILL:
      SetCriteriaProgress(achievementCriteria,
                          referencePlayer->GetUInt32Value(
                              PLAYER_FIELD_LIFETIME_HONORABLE_KILLS),
                          referencePlayer);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_HIGHEST_GOLD_VALUE_OWNED:
      SetCriteriaProgress(achievementCriteria, referencePlayer->GetMoney(),
                          referencePlayer, PROGRESS_HIGHEST);
      break;
    case ACHIEVEMENT_CRITERIA_TYPE_EARN_ACHIEVEMENT_POINTS:
      if (!miscValue1)
        SetCriteriaProgress(achievementCriteria, _achievementPoints,
                            referencePlayer, PROGRESS_SET);
      else
        SetCriteriaProgress(achievementCriteria, miscValue1, referencePlayer,
                            PROGRESS_ACCUMULATE);
      break;
      ...
      } else // login case
      {
        for (uint32 arena_slot = 0; arena_slot < MAX_ARENA_SLOT; ++arena_slot) {
          ...
          if (ArenaTeamMember const *member =
                  team->GetMember(referencePlayer->GetGUID())) {
...
template <class T>
bool AchievementMgr<T>::IsCompletedCriteria(
  ...
  if (achievement->Flags &
      (ACHIEVEMENT_FLAG_REALM_FIRST_REACH | ACHIEVEMENT_FLAG_REALM_FIRST_KILL |
       ACHIEVEMENT_FLAG_REALM_FIRST_GUILD)) {
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_LOOT_EPIC_ITEM:
    return achievementCriteria->Amount &&
           progress->counter >= achievementCriteria->Amount;
  case ACHIEVEMENT_CRITERIA_TYPE_ON_LOGIN:
    return true;
...
template <class T>
void AchievementMgr<T>::CompletedCriteriaFor(
    AchievementEntry const *achievement, Player *referencePlayer) {
  // counter can never complete
  if (achievement->Flags & ACHIEVEMENT_FLAG_COUNTER)
    return;
...
bool AchievementMgr<T>::IsCompletedAchievement(AchievementEntry const *entry) {
  ...
  uint32 achievementForTestId =
      entry->SharesCriteria ? entry->SharesCriteria : entry->ID;
  ...
  AchievementCriteriaEntryList const *cList =
      sAchievementMgr->GetAchievementCriteriaByAchievement(
          achievementForTestId);
  if (!cList)
    return false;
  uint64 count = 0;

  // For SUMM achievements, we have to count the progress of each criteria of
  // the achievement. Oddly, the target count is NOT contained in the
...
template <class T>
CriteriaProgress *
AchievementMgr<T>::GetCriteriaProgress(AchievementCriteriaEntry const *entry) {
...
template <class T>
void AchievementMgr<T>::SetCriteriaProgress(
    AchievementCriteriaEntry const *entry, uint64 changeValue,
    Player *referencePlayer, ProgressType ptype) {
  ...
  LOG_DEBUG("achievement", "SetCriteriaProgress({}, " UI64FMTD ") for ({})",
  ...
  progress->date =
      GameTime::GetGameTime(); // set the date to the latest update.

  AchievementEntry const *achievement =
      sAchievementMgr->GetAchievement(entry->ReferredAchievement);
  ...
  if (criteriaComplete &&
      achievement->Flags & ACHIEVEMENT_FLAG_SHOW_CRITERIA_MEMBERS &&
      !progress->CompletedGUID)
  ...
  if (!m_timedAchievements.empty()) {
    for (TimedAchievementMap::iterator itr = m_timedAchievements.begin();
      ...
      if (itr->second <= timeDiff) {
        AchievementCriteriaEntry const *entry =
            sAchievementMgr->GetAchievementCriteria(itr->first);
...
template <class T>
void AchievementMgr<T>::StartTimedAchievement(
    AchievementCriteriaTimedTypes /*type*/, uint32 /*entry*/,
    uint32 /*timeLost = 0*/) {}

template <>
void AchievementMgr<Player>::StartTimedAchievement(
    AchievementCriteriaTimedTypes type, uint32 entry,
    uint32 timeLost /* = 0 */) {
  AchievementCriteriaEntryList const &achievementCriteriaList =
  ...
  for (AchievementCriteriaEntryList::const_iterator i =
    ...
    AchievementEntry const *achievement =
        sAchievementMgr->GetAchievement((*i)->ReferredAchievement);
    if (m_timedAchievements.find((*i)->ID) == m_timedAchievements.end() &&
      ...
      if ((*i)->StartTimer * IN_MILLISECONDS > timeLost) {
        m_timedAchievements[(*i)->ID] =
            (*i)->StartTimer * IN_MILLISECONDS - timeLost;
...
template <class T>
void AchievementMgr<T>::RemoveTimedAchievement(
    AchievementCriteriaTimedTypes type, uint32 entry) {
  AchievementCriteriaEntryList const &achievementCriteriaList =
      sAchievementMgr->GetTimedAchievementCriteriaByType(type);
  for (AchievementCriteriaEntryList::const_iterator i =
...
template <>
void AchievementMgr<Player>::CompletedAchievement(
    AchievementEntry const *achievement, Player *referencePlayer) {
  // disable for gamemasters with GM-mode enabled
  if (GetOwner()->IsGameMaster())
    return;
  ...
  if (achievement->Flags & ACHIEVEMENT_FLAG_SHOW_IN_GUILD_NEWS)
    if (Guild *guild = referencePlayer->GetGuild())
      guild->AddGuildNews(
          GUILD_NEWS_PLAYER_ACHIEVEMENT, referencePlayer->GetGUID(),
          achievement->Flags & ACHIEVEMENT_FLAG_SHOW_IN_GUILD_HEADER,
          achievement->ID);

  if (!GetOwner()->GetSession()->PlayerLoading())
    SendAchievementEarned(achievement);

  LOG_INFO("achievement",
           "AchievementMgr::CompletedAchievement({}). Player: {} ({})",
           achievement->ID, GetOwner()->GetName().c_str(),
  ...
  if (uint32 titleId =
          reward
              ->TitleID[achievement->ID == 1793
                            ? GetOwner()->GetByteValue(
                                  PLAYER_BYTES_3, PLAYER_BYTES_3_OFFSET_GENDER)
                            : (GetOwner()->GetTeam() == ALLIANCE ? 0 : 1)])
    if (CharTitlesEntry const *titleEntry =
            sCharTitlesStore.LookupEntry(titleId))
      GetOwner()->SetTitle(titleEntry);
  ...
  if (reward->Sender) {
    ...
    Item *item = reward->ItemID
                     ? Item::CreateItem(reward->ItemID, 1, GetOwner())
                     : nullptr;
    if (item) {
    ...
    draft.SendMailTo(trans, GetOwner(),
...
template <>
void AchievementMgr<Guild>::CompletedAchievement(
    AchievementEntry const *achievement, Player *referencePlayer) {
  LOG_DEBUG("achievement", "AchievementMgr<Guild>::CompletedAchievement({})",
            achievement->ID);
  ...
  if (achievement->Flags & ACHIEVEMENT_FLAG_SHOW_IN_GUILD_NEWS)
    if (Guild *guild = referencePlayer->GetGuild())
      guild->AddGuildNews(GUILD_NEWS_GUILD_ACHIEVEMENT, ObjectGuid::Empty,
                          achievement->Flags &
  ...
  if (achievement->Flags & ACHIEVEMENT_FLAG_SHOW_GUILD_MEMBERS) {
    ...
    if (Group const *group = referencePlayer->GetGroup())
      for (GroupReference const *ref = group->GetFirstMember(); ref != nullptr;
           ref = ref->next())
...
void AchievementMgr<T>::SendAllAchievementData(Player * /*receiver*/) const {
  ...
  size_t numAchievements =
      std::count_if(m_completedAchievements.begin(),
                    m_completedAchievements.end(), isVisible);
  ByteBuffer criteriaData(numCriteria * (4 + 4 + 4 + 4 + 8 + 8));
  ObjectGuid guid = GetOwner()->GetGUID();
  ObjectGuid counter;

  WorldPacket data(SMSG_ALL_ACHIEVEMENT_DATA,
                   4 + numAchievements * (4 + 4) + 4 +
                       numCriteria * (4 + 4 + 4 + 4 + 8 + 8));
...
void AchievementMgr<Guild>::SendAllAchievementData(Player *receiver) const {
  ...
  auto count = std::count_if(m_completedAchievements.begin(),
                             m_completedAchievements.end(), isVisible);
...
template <>
void AchievementMgr<Player>::SendAchievementInfo(
    Player *receiver, uint32 /*achievementId = 0 */) const {
  ObjectGuid guid = GetOwner()->GetGUID();
  ObjectGuid counter;
...
template <>
void AchievementMgr<Guild>::SendAchievementInfo(
    Player *receiver, uint32 achievementId /*= 0*/) const {
  // will send response to criteria progress request
  AchievementCriteriaEntryList const *criteria =
      sAchievementMgr->GetAchievementCriteriaByAchievement(achievementId);
  if (!criteria) {
    // send empty packet
  ...
  for (AchievementCriteriaEntryList::const_iterator itr = criteria->begin();
       itr != criteria->end(); ++itr) {
    uint32 criteriaId = (*itr)->ID;
    CriteriaProgressMap::const_iterator progress =
        m_criteriaProgress.find(criteriaId);
    if (progress == m_criteriaProgress.end())
      continue;
  ...
  WorldPacket data(SMSG_GUILD_CRITERIA_DATA,
                   3 + numCriteria * (1 + 1 + 1 + 1 + 4 + 4 + 4 + 4 + 4));
  data.WriteBits(numCriteria, 21);
...
AchievementMgr<T>::GetCompletedDataForAchievement(uint32 achievementId) {
  CompletedAchievementMap::iterator itr =
      m_completedAchievements.find(achievementId);
...
template <class T>
bool AchievementMgr<T>::CanUpdateCriteria(
    AchievementCriteriaEntry const *criteria,
    AchievementEntry const *achievement, uint64 miscValue1, uint64 miscValue2,
    uint64 miscValue3, Unit const *unit, Player *referencePlayer,
    GameObject *go) {
  if (DisableMgr::IsDisabledFor(DISABLE_TYPE_ACHIEVEMENT_CRITERIA, criteria->ID,
                                nullptr)) {
    LOG_TRACE("achievement", "CanUpdateCriteria: (Id: {} Type {}) Disabled",
              criteria->ID,
              AchievementGlobalMgr::GetCriteriaTypeString(criteria->Type));
    return false;
  }

  if (achievement->MapID != -1 &&
      referencePlayer->GetMapId() != uint32(achievement->MapID)) {
    LOG_TRACE("achievement",
  ...
  if ((achievement->Faction == ACHIEVEMENT_FACTION_HORDE &&
       referencePlayer->GetTeam() != HORDE) ||
      (achievement->Faction == ACHIEVEMENT_FACTION_ALLIANCE &&
       referencePlayer->GetTeam() != ALLIANCE)) {
    LOG_TRACE(
        "achievement",
  ...
  if (IsCompletedCriteria(criteria, achievement)) {
    LOG_TRACE("achievement",
              "CanUpdateCriteria: {} (Id: {} Type {}) Is Completed",
              criteria->Description, criteria->ID,
              AchievementGlobalMgr::GetCriteriaTypeString(criteria->Type));
    return false;
  }

  if (!RequirementsSatisfied(criteria, miscValue1, miscValue2, miscValue3, unit,
                             referencePlayer, go)) {
    LOG_TRACE(
        "achievement",
        "CanUpdateCriteria: {} (Id: {} Type {}) Requirements not satisfied",
        criteria->Description, criteria->ID,
        AchievementGlobalMgr::GetCriteriaTypeString(criteria->Type));
    return false;
  }

  if (!AdditionalRequirementsSatisfied(criteria, miscValue1, miscValue2, unit,
                                       referencePlayer)) {
    LOG_TRACE("achievement",
              "CanUpdateCriteria: {} (Id: {} Type {}) Additional requirements "
              "not satisfied",
              criteria->Description, criteria->ID,
              AchievementGlobalMgr::GetCriteriaTypeString(criteria->Type));
    return false;
  ...
  if (!ConditionsSatisfied(criteria, referencePlayer)) {
    LOG_TRACE("achievement",
              "CanUpdateCriteria: (Id: {} Type {}) Conditions not satisfied",
              criteria->ID,
              AchievementGlobalMgr::GetCriteriaTypeString(criteria->Type));
    return false;
  }
...
template <class T>
bool AchievementMgr<T>::ConditionsSatisfied(
    AchievementCriteriaEntry const *criteria, Player *referencePlayer) const {
  for (uint32 i = 0; i < MAX_CRITERIA_REQUIREMENTS; ++i) {
    ...
    case ACHIEVEMENT_CRITERIA_CONDITION_BG_MAP:
      if (referencePlayer->GetMapId() !=
          criteria->AdditionalRequirements[i].Asset)
        return false;
      break;
  ...
  if (criteria->RequiredWorldStateID != 0)
    if (Map *map = referencePlayer->GetMap())
      if (map->GetWorldStateValue(criteria->RequiredWorldStateID) !=
          criteria->RequiredWorldStateValue)
        return false;
...
template <class T>
bool AchievementMgr<T>::RequirementsSatisfied(
    AchievementCriteriaEntry const *achievementCriteria, uint64 miscValue1,
    uint64 miscValue2, uint64 miscValue3, Unit const *unit,
    Player *referencePlayer, GameObject *go) const {
  switch (AchievementCriteriaTypes(achievementCriteria->Type)) {
  case ACHIEVEMENT_CRITERIA_TYPE_ACCEPTED_SUMMONINGS:
  case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_DAILY_QUEST:
  case ACHIEVEMENT_CRITERIA_TYPE_CREATE_AUCTION:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_ACHIEVEMENT:
    if ((miscValue1 &&
         achievementCriteria->Asset.AchievementID != miscValue1) ||
        (!miscValue1 && m_completedAchievements.find(
                            achievementCriteria->Asset.AchievementID) ==
                            m_completedAchievements.end()))
      return false;
    break;
  case ACHIEVEMENT_CRITERIA_TYPE_CRAFT_ITEMS_GUILD:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_WIN_BG:
    if (!miscValue1 ||
        achievementCriteria->Asset.MapID != referencePlayer->GetMapId())
      return false;
    break;
  case ACHIEVEMENT_CRITERIA_TYPE_KILL_CREATURE:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_BATTLEGROUND:
    if (!miscValue1 ||
        referencePlayer->GetMapId() != achievementCriteria->Asset.MapID)
      return false;
    break;
  case ACHIEVEMENT_CRITERIA_TYPE_DEATH_AT_MAP:
    if (!miscValue1 ||
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_DEATH_IN_DUNGEON: {
    ...
    Map const *map = referencePlayer->IsInWorld()
                         ? referencePlayer->GetMap()
                         : sMapMgr->FindMap(referencePlayer->GetMapId(),
                                            referencePlayer->GetInstanceId());
    ...
    for (int j = 0; achievIdForDungeon[j][0]; ++j) {
      if (achievIdForDungeon[j][0] ==
          achievementCriteria->ReferredAchievement) {
        if (map->IsRaid()) {
          // if raid accepted (ignore difficulty)
          if (!achievIdForDungeon[j][2])
            break; // for
        } else if (referencePlayer->GetDungeonDifficulty() ==
    ...
    if (((InstanceMap *)map)->GetMaxPlayers() !=
        achievementCriteria->Asset.GroupSize)
      return false;
    break;
  }
  case ACHIEVEMENT_CRITERIA_TYPE_KILLED_BY_CREATURE:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_QUEST: {
    ...
    if (miscValue1) {
      ...
      // login case.
      if (!referencePlayer->GetQuestRewardStatus(
              achievementCriteria->Asset.QuestID))
        return false;
    }
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_LOOT_TYPE:
    ...
    if (!miscValue1 || !miscValue2 || !miscValue3 ||
        miscValue3 != achievementCriteria->Asset.LootType)
      return false;
    break;
  case ACHIEVEMENT_CRITERIA_TYPE_OWN_ITEM:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_EXPLORE_AREA: {
    WorldMapOverlayEntry const *worldOverlayEntry =
        sWorldMapOverlayStore.LookupEntry(
            achievementCriteria->Asset.WorldMapOverlayID);
    ...
    for (int j = 0; j < MAX_WORLD_MAP_OVERLAY_AREA_IDX; ++j) {
      AreaTableEntry const *area =
          sAreaTableStore.LookupEntry(worldOverlayEntry->AreaID[j]);
      if (!area)
        break;
      ...
      if (referencePlayer->GetUInt32Value(PLAYER_EXPLORED_ZONES_1 +
                                          playerIndexOffset) &
          mask) {
        matchFound = true;
        break;
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_GUILD_CHALLENGE_TYPE:
    if (!miscValue1 ||
        miscValue1 != achievementCriteria->Asset.GuildChallengeType)
      return false;
    break;
  case ACHIEVEMENT_CRITERIA_TYPE_EQUIP_EPIC_ITEM:
  ...
  case ACHIEVEMENT_CRITERIA_TYPE_HEALING_DONE:
    ...
    if (achievementCriteria->AdditionalRequirements[0].Type ==
        ACHIEVEMENT_CRITERIA_CONDITION_BG_MAP) {
      if (referencePlayer->GetMapId() !=
          achievementCriteria->AdditionalRequirements[0].Asset)
        return false;
...
template <class T>
bool AchievementMgr<T>::AdditionalRequirementsSatisfied(
    AchievementCriteriaEntry const *criteria, uint64 miscValue1,
    uint64 miscValue2, Unit const *unit, Player *referencePlayer) const {
  for (uint8 i = 0; i < MAX_ADDITIONAL_CRITERIA_CONDITIONS; ++i) {
    ...
    {
      uint64 itemId =
          (criteria->Type == ACHIEVEMENT_CRITERIA_TYPE_EQUIP_EPIC_ITEM
               ? miscValue2
               : miscValue1);
      ItemTemplate const *const item =
          sObjectMgr->GetItemTemplate(uint32(itemId));
    ...
    case ACHIEVEMENT_CRITERIA_ADDITIONAL_CONDITION_PROJECT_RARITY: // 65
    {
      ...
      ResearchProjectEntry const *rp =
          sResearchProjectStore.LookupEntry(miscValue1);
      if (!rp)
        return false;
...
char const *
AchievementGlobalMgr::GetCriteriaTypeString(AchievementCriteriaTypes type) {
  switch (type) {
  case ACHIEVEMENT_CRITERIA_TYPE_KILL_CREATURE:
...
inline bool
IsAchievementCriteriaTypeStoredByMiscValue(AchievementCriteriaTypes type) {
  switch (type) {
  case ACHIEVEMENT_CRITERIA_TYPE_KILL_CREATURE:
  case ACHIEVEMENT_CRITERIA_TYPE_WIN_BG:
  case ACHIEVEMENT_CRITERIA_TYPE_REACH_SKILL_LEVEL:
...
AchievementGlobalMgr::GetAchievementCriteriaByType(
    AchievementCriteriaTypes type, uint32 miscValue, bool guild) const {
  if (guild) {
...
void AchievementGlobalMgr::SetRealmCompleted(
  ...
  _allCompletedAchievements[achievement->ID] =
      GameTime::GetGameTimeSystemPoint();
}
...
void AchievementGlobalMgr::LoadAchievementCriteriaList() {
  ...
  for (uint32 entryId = 0; entryId < sAchievementCriteriaStore.GetNumRows();
       ++entryId) {
    AchievementCriteriaEntry const *criteria =
        sAchievementMgr->GetAchievementCriteria(entryId);
    if (!criteria)
      continue;

    ASSERT(criteria->Type < ACHIEVEMENT_CRITERIA_TYPE_TOTAL,
           "ACHIEVEMENT_CRITERIA_TYPE_TOTAL must be greater than or equal to "
           "{} but is currently equal to {}",
           criteria->Type + 1, ACHIEVEMENT_CRITERIA_TYPE_TOTAL);

    AchievementEntry const *achievement =
        sAchievementMgr->GetAchievement(criteria->ReferredAchievement);
    ...
    if (IsAchievementCriteriaTypeStoredByMiscValue(
            AchievementCriteriaTypes(criteria->Type))) {
      if (criteria->Type != ACHIEVEMENT_CRITERIA_TYPE_EXPLORE_AREA)
        guild ? m_GuildAchievementCriteriasByMiscValue[criteria->Type]
                                                      [criteria->Asset.ID]
                                                          .push_back(criteria)
              : m_AchievementCriteriasByMiscValue[criteria->Type]
                                                 [criteria->Asset.ID]
                                                     .push_back(criteria);
      else {
        WorldMapOverlayEntry const *worldOverlayEntry =
            sWorldMapOverlayStore.LookupEntry(
                criteria->Asset.WorldMapOverlayID);
        if (!worldOverlayEntry)
          break;
          ...
          if (worldOverlayEntry->AreaID[j]) {
            ...
            for (uint8 i = 0; i < j; ++i)
              if (worldOverlayEntry->AreaID[j] == worldOverlayEntry->AreaID[i])
                valid = false;
            if (valid)
              guild ? m_GuildAchievementCriteriasByMiscValue
                          [criteria->Type][worldOverlayEntry->AreaID[j]]
                              .push_back(criteria)
    ...
    for (uint32 i = 0; i < MAX_CRITERIA_REQUIREMENTS; ++i) {
      if (criteria->AdditionalRequirements[i].Type !=
        ...
        ASSERT(criteria->AdditionalRequirements[i].Type <
                   ACHIEVEMENT_CRITERIA_CONDITION_MAX,
               "ACHIEVEMENT_CRITERIA_CONDITION_MAX must be greater than or "
               "equal to {} but is currently equal to {}",
               criteria->AdditionalRequirements[i].Type + 1,
               ACHIEVEMENT_CRITERIA_CONDITION_MAX);

        if (i == 0 ||
            criteria->AdditionalRequirements[i].Type !=
                criteria->AdditionalRequirements[i - 1].Type ||
            criteria->AdditionalRequirements[i].Asset !=
                criteria->AdditionalRequirements[i - 1].Asset)
    ...
    if (criteria->StartTimer) {
      ASSERT(criteria->StartEvent < ACHIEVEMENT_TIMED_TYPE_MAX,
             "ACHIEVEMENT_TIMED_TYPE_MAX must be greater than or equal to {} "
             "but is currently equal to {}",
             criteria->StartEvent + 1, ACHIEVEMENT_TIMED_TYPE_MAX);
      m_AchievementCriteriasByTimedType[criteria->StartEvent].push_back(
          criteria);
    }
  }

  LOG_INFO("server.loading",
           ">> Loaded {} achievement criteria and {} guild achievement "
           "crieteria in {} ms.",
           criterias, guildCriterias, GetMSTimeDiffToNow(oldMSTime));
}
...
void AchievementGlobalMgr::LoadAchievementReferenceList() {
  ...
  for (uint32 entryId = 0; entryId < sAchievementStore.GetNumRows();
       ++entryId) {
    AchievementEntry const *achievement =
        sAchievementMgr->GetAchievement(entryId);
    if (!achievement || !achievement->SharesCriteria)
      continue;

    m_AchievementListByReferencedId[achievement->SharesCriteria].push_back(
        achievement);
    ++count;
  }
  ...
  if (AchievementEntry const *achievement =
          sAchievementMgr->GetAchievement(4539))
    const_cast<AchievementEntry *>(achievement)->MapID =
        631; // Correct map requirement (currently has Ulduar)

  // Straw That Broke the Camel's Back - Halls of Origination
  if (AchievementEntry const *achievement =
          sAchievementMgr->GetAchievement(5294))
    const_cast<AchievementEntry *>(achievement)->MapID =
        644; // Correct map requirement

  LOG_INFO("server.loading", ">> Loaded {} achievement references in {} ms.",
...
void AchievementGlobalMgr::LoadAchievementCriteriaData() {
  ...
  do {
    ...
    AchievementCriteriaEntry const *criteria =
        sAchievementMgr->GetAchievementCriteria(criteria_id);

    if (!criteria) {
      LOG_ERROR("sql.sql",
                "Table `achievement_criteria_data` contains data for "
                "non-existing criteria (Entry: {}). Ignored.",
                criteria_id);
      continue;
    }
    ...
    if (scriptName.length()) // not empty
    {
      if (dataType != ACHIEVEMENT_CRITERIA_DATA_TYPE_SCRIPT)
        LOG_ERROR("sql.sql",
                  "Table `achievement_criteria_data` contains a ScriptName for "
                  "non-scripted data type (Entry: {}, type {}), useless data.",
                  criteria_id, dataType);
      else
        scriptId = sObjectMgr->GetScriptId(scriptName);
    }

    AchievementCriteriaData data(dataType, fields[2].Get<uint32>(),
                                 fields[3].Get<uint32>(), scriptId);
...
void AchievementGlobalMgr::LoadCompletedAchievements() {
  ...
  if (!result) {
    LOG_INFO("server.loading",
             ">> Loaded 0 realm first completed achievements. DB table "
  ...
  do {
    ...
    if (!achievement) {
      ...
      LOG_ERROR("achievement",
                "Non-existing achievement {} data has been removed from the "
      ...
      continue;
                                     ...
                                     ACHIEVEMENT_FLAG_REALM_FIRST_KILL |
                                     ACHIEVEMENT_FLAG_REALM_FIRST_GUILD))
      _allCompletedAchievements[achievementId] =
          std::chrono::system_clock::time_point::max();
  } while (result->NextRow());

  LOG_INFO("server.loading",
           ">> Loaded {} realm first completed achievements in {} ms.",
...
void AchievementGlobalMgr::LoadRewards() {
  ...
  QueryResult result =
      WorldDatabase.Query("SELECT ID, TitleA, TitleH, ItemID, Sender, Subject, "
                          "Text, MailTemplateID FROM achievement_reward");

  if (!result) {
    LOG_ERROR("server.loading", ">> Loaded 0 achievement rewards. DB table "
  ...
  do {
    ...
    if (!achievement) {
      LOG_ERROR("sql.sql",
                "Table `achievement_reward` contains a wrong achievement ID "
                "({}), ignored.",
                id);
      continue;
    }
    ...
    if (!reward.TitleID[0] && !reward.TitleID[1] && !reward.Sender) {
      LOG_ERROR("sql.sql",
                "Table `achievement_reward` (ID: {}) does not contain title or "
                "item reward data. Ignored.",
                id);
      continue;
    }

    if (achievement->Faction == ACHIEVEMENT_FACTION_ANY &&
        (!reward.TitleID[0] ^ !reward.TitleID[1]))
      LOG_ERROR("sql.sql",
                "Table `achievement_reward` (ID: {}) contains the title (A: {} "
                "H: {}) for only one team.",
                id, reward.TitleID[0], reward.TitleID[1]);
    ...
    if (reward.TitleID[0]) {
      ...
      if (!titleEntry) {
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (Entry: {}) contains an invalid "
                  "title id ({}) in `title_A`, set to 0",
                  id, reward.TitleID[0]);
        reward.TitleID[0] = 0;
      }
    }
    ...
    if (reward.Sender) {
      if (!sObjectMgr->GetCreatureTemplate(reward.Sender)) {
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) contains an invalid "
                  "creature ID {} as sender, mail reward skipped.",
                  id, reward.Sender);
        reward.Sender = 0;
      }
    } else {
      if (reward.ItemID)
        LOG_ERROR(
            "sql.sql",
            "Table `achievement_reward` (ID: {}) does not have sender data, "
            "but contains an item reward. Item will not be rewarded.",
            id);

      if (!reward.Subject.empty())
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) does not have sender "
                  "data, but contains a mail subject.",
                  id);

      if (!reward.Text.empty())
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) does not have sender "
                  "data, but contains mail text.",
                  id);

      if (reward.MailTemplateID)
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) does not have sender "
                  "data, but has a MailTemplate.",
                  id);
    }
    ...
    if (reward.MailTemplateID) {
      if (!sMailTemplateStore.LookupEntry(reward.MailTemplateID)) {
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) is using an invalid "
                  "MailTemplate ({}).",
                  id, reward.MailTemplateID);
        reward.MailTemplateID = 0;
      } else if (!reward.Subject.empty() || !reward.Text.empty())
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) is using MailTemplate "
                  "({}) and mail subject/text.",
                  id, reward.MailTemplateID);
    }
    ...
    if (reward.ItemID) {
      if (!sObjectMgr->GetItemTemplate(reward.ItemID)) {
        LOG_ERROR("sql.sql",
                  "Table `achievement_reward` (ID: {}) contains an invalid "
                  "item id {}, reward mail will not contain the rewarded item.",
                  id, reward.ItemID);
        reward.ItemID = 0;
      }
    }
  ...
  LOG_INFO("server.loading", ">> Loaded {} achievement rewards in {} ms.",
           uint32(m_achievementRewards.size()), GetMSTimeDiffToNow(oldMSTime));
}
...
void AchievementGlobalMgr::LoadRewardLocales() {
  ...
  do {
    ...
    if (m_achievementRewards.find(id) == m_achievementRewards.end()) {
      LOG_ERROR("sql.sql",
                "Table `achievement_reward_locale` (ID: {}) contains locale "
                "strings for a non-existing achievement reward.",
                id);
      continue;
    }
  ...
  LOG_INFO("server.loading",
           ...
           uint32(m_achievementRewardLocales.size()),
           GetMSTimeDiffToNow(oldMSTime));
}
...
AchievementGlobalMgr::GetAchievementCriteria(uint32 criteriaId) const {
