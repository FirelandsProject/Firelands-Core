...
#if FIRELANDS_PLATFORM == FIRELANDS_PLATFORM_WINDOWS // ugly as hell
...
char serviceDescription[] =
    "Firelands Core World of Warcraft emulator world service";
/*
...
extern int main(int argc, char **argv) {
  ...
  auto configFile = fs::path(sConfigMgr->GetConfigPath() +
                             std::string(_FIRELANDS_CORE_CONFIG));
  ...
  Firelands::Banner::Show(
      "worldserver-daemon",
      [](std::string text) { LOG_INFO("server.worldserver", "%s", text); },
      []() {
