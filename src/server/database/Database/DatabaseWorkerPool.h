...
public:
    ...
    */
    ...
    void Execute(std::string_view sql, Args&&... args)
    {
        ...
        Execute(Firelands::StringFormatFmt(sql, std::forward<Args>(args)...));
    }
    ...
    */
    ...
    void DirectExecute(std::string_view sql, Args&&... args)
    {
        ...
        DirectExecute(Firelands::StringFormatFmt(sql, std::forward<Args>(args)...));
    }
    ...
    */
    ...
    QueryResult Query(std::string_view sql, Args&&... args)
    {
        ...
        return Query(Firelands::StringFormatFmt(sql, std::forward<Args>(args)...));
    }
