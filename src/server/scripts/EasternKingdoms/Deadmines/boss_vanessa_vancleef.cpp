 ...
 *
 * Copyright (C) 2008-2011 Firelands <http://www.trinitycore.org/>
 *
 * Copyright (C) 2006-2011 ScriptDev2 <http://www.scriptdev2.com/>
 *
 * Copyright (C) 2010-2011 Project Firelands <http://www.projecttrinity.org/>
 *
...
public:
    ...
    class spell_vc_backslash_target_selector_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& unitList)
        {
            ...
            if (!unitList.empty())
                Firelands::Containers::RandomResizeList(unitList, 1);
        }
