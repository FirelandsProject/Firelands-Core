        ...
        class spell_pal_seal_of_righteousness_AuraScript : public AuraScript
        {
            ...
            void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
            {
                ...
                if (caster->HasAura(SPELL_PALADIN_SEALS_OF_COMMAND))
                {
                    ...
                    Firelands::AnyUnfriendlyUnitInObjectRangeCheck u_check(caster, caster, 5);
                    Firelands::UnitListSearcher<Firelands::AnyUnfriendlyUnitInObjectRangeCheck> searcher(caster, targets, u_check);
