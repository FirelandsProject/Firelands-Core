...
public:
    ...
    class spell_gen_raid_SPELL_SpellScript : public SpellScript
    {
        ...
        {
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_DEBUFF_SATED));
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_DEBUFF_EXHAUSTION));
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_DEBUFF_TEMPORAL_DISPLACEMENT));
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_DEBUFF_INSANITY));
        }
