    ...
    public:
        ...
        class spell_sha_ancestral_awakening_proc_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                targets.clear();
                temp.sort(Firelands::HealthPctOrderPred());
                if (temp.size() > 1)
                    temp.resize(1);
    ...
    public:
        ...
        class spell_sha_fire_nova_SpellScript : public SpellScript
        {
            ...
            SpellCastResult CheckCast()
            {
                ...
                Firelands::AnyUnfriendlyUnitInObjectRangeCheck u_check(GetCaster(), GetCaster(), 100.0f);
                Firelands::UnitListSearcher<Firelands::AnyUnfriendlyUnitInObjectRangeCheck> searcher(GetCaster(), targets, u_check);
    ...
    public:
        ...
        class spell_sha_lava_lash_trigger_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& unitList)
            {
                ...
                targets.remove_if(Firelands::UnitAuraCheck(true, 8050, GetCaster()->GetGUID()));

                if (!targets.empty())
                    Firelands::Containers::RandomResizeList(targets, 4);
            }
