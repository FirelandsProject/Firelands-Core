...
public:
    ...
    struct boss_sartharionAI : public BossAI
    {
        ...
        void EnterCombat(Unit* pWho)
        {
            ...
            Firelands::AnyUnitInObjectRangeCheck u_check(me, 1000.0f);
        ...
        void CastLavaStrike(bool addAura)
        {
            ...
            Firelands::CreatureListSearcher<Firelands::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
