    ...
    public:
        ...
        struct boss_ammunaeAI : public BossAI
        {
            ...
            void RampartSummon(uint32 entry, float distance)
            {
                ...
                Firelands::AllCreaturesOfEntryInRange checker(me, entry, distance);
                Firelands::CreatureListSearcher<Firelands::AllCreaturesOfEntryInRange> searcher(me, CreatureList, checker);
