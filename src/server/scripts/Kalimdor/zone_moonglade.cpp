...
public:
    ...
    public:
        ...
        void IsSummonedBy(Unit* /*summoner*/)
        {
            ...
            Firelands::AnyPlayerInObjectRangeCheck checker(me, 5.0f);
            Firelands::PlayerListSearcher<Firelands::AnyPlayerInObjectRangeCheck> searcher(me, playerOnQuestList, checker);
