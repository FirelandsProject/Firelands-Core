                        ...
                        else
                        {
                            ...
                            if (Creature* trigger = me->SummonCreature(NPC_SPLITTING_BLOW_TRIGGER, spawnPos, TEMPSUMMON_MANUAL_DESPAWN))
                            {
                                ...
                                if (IsHeroic())
                                {
                                    ...
                                    Firelands::Containers::RandomResizeList(sonSpawnPos, 8);
                                }
    ...
    class spell_fl_summon_living_meteor_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            if (Creature* caster = GetCaster()->ToCreature())
            {
                ...
                if (!targets.empty())
                    Firelands::Containers::RandomResizeList(targets, summonCount);
            }
        }
...
public:
    ...
    class spell_fl_superheated_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            targets.remove_if(Firelands::UnitAuraCheck(true, deluge));
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_BREADTH_OF_FROST_PROTECTION));
...
public:
    ...
    class spell_fl_lava_bolt_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            if (!targets.empty())
                Firelands::Containers::RandomResizeList(targets, GetCaster()->GetMap()->Is25ManRaid() ? 8 : 3);
