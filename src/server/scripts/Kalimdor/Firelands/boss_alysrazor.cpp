...
public:
    ...
    class spell_alysrazor_blazing_power_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_BLAZING_POWER_PREVENTION_AURA));
...
public:
    ...
    class spell_alysrazor_imprinted_targeting_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_IMPRINTED));
            targets.remove_if(Firelands::UnitAuraCheck(true, SPELL_IMPRINTED_2));
