...
public:
    ...
    class spell_countdown_p1_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            Firelands::Containers::RandomResizeList(targets, 2);
...
public:
    ...
    class spell_countdown_p3_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            targets.remove_if(Firelands::UnitAuraCheck(false, SPELL_COUNTDOWN_PERIODIC));
...
public:
    ...
    class spell_shards_of_torment_SpellScript : public SpellScript
    {
        ...
        void FilterTargets(std::list<WorldObject*>& targets)
        {
            ...
            {
                WorldObject* target = Firelands::Containers::SelectRandomContainerElement(ranged);
