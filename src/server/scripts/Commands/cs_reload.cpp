...
public:
    ...
    {
        LOG_INFO("misc", "Loading Quests Relations... (`creature_questrelation`)");
    ...
    {
        LOG_INFO("misc", "Loading Quests Relations... (`creature_involvedrelation`)");
    ...
    {
        LOG_INFO("misc", "Loading Quests Relations... (`gameobject_questrelation`)");
    ...
    {
        LOG_INFO("misc", "Loading Quests Relations... (`gameobject_involvedrelation`)");
    ...
    {
        LOG_INFO("misc", "Re-Loading `npc_trainer` Table!");
    ...
    {
        LOG_INFO("misc", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Page Texts...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Script strings from `db_script_string`...");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Item ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales NPC Text ... ");
    ...
    {
        LOG_INFO("misc", "Re-Loading Locales Quest ... ");
    ...
    {
        LOG_INFO("misc", "Reloading phase_definitions table...");
    ...
    {
        LOG_INFO("server.worldserver", "Reloading PerformanceLog config");
        sPerfLog->LoadConfig();
    ...
    {
        LOG_INFO("misc", "Reloading instance teleporter destinations...");
