...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        CellCoord pair(Firelands::ComputeCellCoord(object->GetPositionX(), object->GetPositionY()));
        Cell cell(pair);
        cell.SetNoCreate();
        ...
        TypeContainerVisitor<Firelands::CreatureListSearcher<Firelands::AnyUnitInObjectRangeCheck>, GridTypeMapContainer> go_visit(go_search);
        ...
        {
            handler->PSendSysMessage(Firelands::StringFormatFmt("Found {} Creatures.", creatureList.size()));
