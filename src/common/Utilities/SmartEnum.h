...
#ifndef FIRELANDS_SMARTENUM_H
#define FIRELANDS_SMARTENUM_H
...
public:
    template <typename Enum>
    static size_t Count() { return Firelands::Impl::EnumUtilsImpl::EnumUtils<Enum>::Count(); }
    template <typename Enum>
    static EnumText ToString(Enum value) { return Firelands::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToString(value); }
    template <typename Enum>
    static Enum FromIndex(size_t index) { return Firelands::Impl::EnumUtilsImpl::EnumUtils<Enum>::FromIndex(index); }
    template <typename Enum>
