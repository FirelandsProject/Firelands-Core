    ...
    struct boss_devourer_of_soulsAI : public ScriptedAI
    {
        ...
        void JustSummoned(Creature* pSummoned) override
        {
            ...
            else if (pSummoned->GetEntry() == NPC_UNLEASHED_SOUL)
            {
                ...
                pSummoned->ForcedDespawn(15000);                // Note that this is sort of a hack, the more correct fix however would require to toggle the interpretation of summon properties in firelands
            }
        }
