...
SDName: Boss_Gruul
SD%Complete: 60
SDComment: Ground Slam need further development (knock back effect and shatter effect must be added to firelands)
...
struct boss_gruul : public CreatureScript
{
    ...
    struct boss_gruulAI : public ScriptedAI
    {
        ...
        void SpellHitTarget(Unit* pTarget, const SpellEntry* pSpell) override
        {
            ...
            // this part should be in firelands
            if (pSpell->Id == SPELL_SHATTER)
            {
                // this spell must have custom handling in firelands, dealing damage based on distance
