...
#if (defined(TBC) || defined(WOTLK) || defined(CATA)) && !defined(MANGOS) && !defined(FIRELANDS)
...
#if defined(CATA) || defined(MISTS) || (defined(WOTLK) && !defined(MANGOS) && !defined(FIRELANDS))
