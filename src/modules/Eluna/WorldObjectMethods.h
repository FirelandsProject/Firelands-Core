...
namespace LuaWorldObject
{
    ...
    */
    ...
    int GetNearestPlayer(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::UnitLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(target, checker);
    ...
    int GetNearestGameObject(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::GameObjectLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(target, checker);
    ...
    int GetNearestCreature(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::CreatureLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(target, checker);
        Cell::VisitGridObjects(obj, searcher, range);
    ...
    int GetPlayersInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::PlayerListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(list, checker);
        Cell::VisitWorldObjects(obj, searcher, range);
#endif
    ...
    int GetCreaturesInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::CreatureListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(list, checker);
        Cell::VisitGridObjects(obj, searcher, range);
#endif
    ...
    int GetGameObjectsInRange(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::GameObjectListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(list, checker);
        Cell::VisitGridObjects(obj, searcher, range);
#endif
    ...
    int GetNearObject(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::WorldObjectLastSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(target, checker);
        Cell::VisitAllObjects(obj, searcher, range);
#endif
    ...
    int GetNearObjects(lua_State* L, WorldObject* obj)
    {
        ...
        Cell::VisitAllObjects(obj, searcher, range);
#else
        Firelands::WorldObjectListSearcher<ElunaUtil::WorldObjectInRangeCheck> searcher(list, checker);
        Cell::VisitAllObjects(obj, searcher, range);
#endif
...
#if defined(MANGOS) || defined(FIRELANDS)
