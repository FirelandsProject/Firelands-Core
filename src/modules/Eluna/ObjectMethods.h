 ...
 *
 * Objects in Firelands/Trinity are stored an a giant block of "values".
...
namespace LuaObject
{
     ...
     *
     * However on Firelands and cMangos creatures and gameobjects inside different maps can share
