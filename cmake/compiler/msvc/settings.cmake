...
if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS MSVC_EXPECTED_VERSION)
  message(FATAL_ERROR "MSVC: Firelands Core requires version ${MSVC_EXPECTED_VERSION} (${MSVC_EXPECTED_VERSION_STRING}) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
endif()
...
target_compile_options(firelands-warning-interface
  INTERFACE
  /W3)
...
if(NOT(CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.23026.0))
  # makes this flag a requirement to build FC at all
  target_compile_options(firelands-compile-option-interface
    INTERFACE
    /Zc:throwingNew)
endif()
